(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))s(i);new MutationObserver(i=>{for(const a of i)if(a.type==="childList")for(const r of a.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&s(r)}).observe(document,{childList:!0,subtree:!0});function n(i){const a={};return i.integrity&&(a.integrity=i.integrity),i.referrerPolicy&&(a.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?a.credentials="include":i.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function s(i){if(i.ep)return;i.ep=!0;const a=n(i);fetch(i.href,a)}})();const P={PROFILES:"swaf_profiles",TANDEMS:"swaf_tandems",GAMIFICATION:"swaf_gamification_stats",PLZ_CACHE:"swaf_plz_cache",SETTINGS:"swaf_settings"};let $=[],E=[],A=lt(),G=new Map;function lt(){return{totalMatches:0,todayMatches:0,lastMatchDate:"",streak:0,qualityScores:[],achievements:[],totalPoints:0}}async function $t(){try{const e=localStorage.getItem(P.PROFILES);e&&($=JSON.parse(e));const t=localStorage.getItem(P.TANDEMS);t&&(E=JSON.parse(t));const n=localStorage.getItem(P.GAMIFICATION);n&&(A={...lt(),...JSON.parse(n)});const s=localStorage.getItem(P.PLZ_CACHE);if(s){const i=JSON.parse(s);G=new Map(Object.entries(i))}console.log(`Storage initialized: ${$.length} profiles, ${E.length} tandems`)}catch(e){console.error("Error loading storage:",e)}}function we(){return[...$]}function de(e){return $.find(t=>t.id===e)}function St(e){const t=new Set($.map(s=>s.id)),n=new Set($.map(s=>ye(s.name)));for(const s of e){if(t.has(s.id))continue;const i=ye(s.name);if(n.has(i)){const a=$.find(r=>ye(r.name)===i);if(a){Mt(a,s);continue}}$.push(s),t.add(s.id),n.add(i)}dt()}function Mt(e,t){const n=new Set(e.fields.map(s=>s.question));for(const s of t.fields)n.has(s.question)||e.fields.push(s);e.pageType="Merged",e.timestamp=Math.max(e.timestamp,t.timestamp)}function ye(e){return e.toLowerCase().trim().replace(/\s+/g," ")}function dt(){localStorage.setItem(P.PROFILES,JSON.stringify($)),window.dispatchEvent(new CustomEvent("profiles-updated"))}function se(){return[...E]}function It(e){E.push(e),be(),A.totalMatches++,A.todayMatches++,A.lastMatchDate=new Date().toISOString().split("T")[0],A.qualityScores.push(e.matchScore),mt()}function ut(e){E=E.filter(t=>t.id!==e),be()}function Tt(e,t){const n=E.findIndex(s=>s.id===e);n!==-1&&(E[n]={...E[n],...t},be())}function ve(){const e=new Set;for(const t of E)e.add(t.profile1.id),e.add(t.profile2.id);return e}function V(e){return E.find(t=>t.profile1.id===e||t.profile2.id===e)}function be(){localStorage.setItem(P.TANDEMS,JSON.stringify(E)),window.dispatchEvent(new CustomEvent("tandems-updated"))}function Ct(){return{...A}}function mt(){localStorage.setItem(P.GAMIFICATION,JSON.stringify(A))}function xt(e){return G.get(e)}function ht(e,t){G.set(e,t);const n=Object.fromEntries(G);localStorage.setItem(P.PLZ_CACHE,JSON.stringify(n))}function zt(e){if(!e.profiles||!Array.isArray(e.profiles))throw new Error("Ungültiges Datenformat");const t=$.length;return St(e.profiles),$.length-t}function Pt(){return JSON.stringify({profiles:$,tandems:E,gamificationStats:A,plzCache:Object.fromEntries(G),exportedAt:new Date().toISOString(),version:"2.0"})}function At(e){const t=JSON.parse(e);t.profiles&&($=t.profiles),t.tandems&&(E=t.tandems),t.gamificationStats&&(A=t.gamificationStats),t.plzCache&&(G=new Map(Object.entries(t.plzCache))),dt(),be(),mt(),localStorage.setItem(P.PLZ_CACHE,JSON.stringify(Object.fromEntries(G)))}function O(e){const t=e.fields.find(n=>n.question.toLowerCase().includes("plz")||n.question.toLowerCase().includes("postleitzahl"));if(t!=null&&t.answer){const n=t.answer.match(/\d{5}/);return n?n[0]:null}for(const n of e.fields){const s=n.answer.match(/\b\d{5}\b/);if(s)return s[0]}return null}function ne(e){const t=[/newcomer/i,/geflüchtet/i,/migrant/i,/zugewandert/i,/immigrant/i,/einwander/i,/neuankommend/i,/geflohene?/i,/refugee/i,/asyl/i,/zuwander/i],n=[/\blocal\b/i,/einheimisch/i,/hier.*geboren/i,/alteingesessen/i,/ortsansässig/i],s=a=>t.some(r=>r.test(a)),i=a=>n.some(r=>r.test(a));if(e.pageType){if(s(e.pageType))return"newcomer";if(i(e.pageType))return"local"}if(e.name){if(s(e.name))return"newcomer";if(i(e.name))return"local"}if(e.url){if(s(e.url))return"newcomer";if(i(e.url))return"local"}for(const a of e.fields){const r=a.question.toLowerCase(),o=a.answer;if(r.includes("gruppe")||r.includes("status")||r.includes("wer bist")||r.includes("local")||r.includes("newcomer")||r.includes("herkunft")||r.includes("aufnahme")||r.includes("teilnehmer")){if(s(o))return"newcomer";if(i(o))return"local"}}for(const a of e.fields)if(s(a.answer))return"newcomer";return"local"}function Q(e){const t=e.fields.find(s=>s.question.toLowerCase().includes("alter")&&!s.question.toLowerCase().includes("unterschied")&&!s.question.toLowerCase().includes("präferenz"));if(t!=null&&t.answer){const s=t.answer.match(/\d+/);if(s){const i=parseInt(s[0]);if(i>=16&&i<=100)return i}}const n=e.fields.find(s=>s.question.toLowerCase().includes("geboren")||s.question.toLowerCase().includes("geburtsjahr"));if(n!=null&&n.answer){const s=n.answer.match(/(19|20)\d{2}/);if(s){const i=parseInt(s[0]),r=new Date().getFullYear()-i;if(r>=16&&r<=100)return r}}return null}function ue(e){const t=e.fields.find(n=>n.question.toLowerCase().includes("geschlecht")&&!n.question.toLowerCase().includes("präferenz")&&!n.question.toLowerCase().includes("partner"));if(t!=null&&t.answer){const n=t.answer.toLowerCase();if(n.includes("männlich")||n.includes("mann")||n==="m")return"male";if(n.includes("weiblich")||n.includes("frau")||n==="w"||n==="f")return"female";if(n.includes("divers")||n.includes("sonstig")||n.includes("andere"))return"other"}return null}const Bt={sport:["sport","fitness","training","gym","workout"],fussball:["fußball","fussball","soccer","kicken"],musik:["musik","music","konzert","singen","instrument"],lesen:["lesen","bücher","reading","books"],kochen:["kochen","cooking","backen","küche"],reisen:["reisen","travel","urlaub","reise"],kino:["kino","filme","movies","cinema","film"],gaming:["gaming","videospiele","spiele","zocken","games"],wandern:["wandern","hiking","spazieren","natur"],fotografie:["fotografie","photography","fotos","fotografieren"],kunst:["kunst","art","malen","zeichnen","museum"],tanzen:["tanzen","dance","dancing","tanz"],yoga:["yoga","meditation","entspannung"],schwimmen:["schwimmen","swimming","baden"],radfahren:["radfahren","fahrrad","cycling","bike","rad"],laufen:["laufen","joggen","running","jogging"],sprachen:["sprachen","languages","sprachkurs"],essen:["essen","food","kulinarik","restaurant"],feiern:["feiern","party","ausgehen","club","bar"],natur:["natur","nature","garten","pflanzen","outdoor"]};function Ue(e){const t=e.toLowerCase().trim();for(const[n,s]of Object.entries(Bt))if(s.some(i=>t.includes(i)))return n;return t.replace(/[^a-zäöüß]/gi,"")}const qt={"01":{lat:51.05,lng:13.74,city:"Dresden"},"02":{lat:51.15,lng:14.97,city:"Görlitz"},"03":{lat:51.76,lng:14.33,city:"Cottbus"},"04":{lat:51.34,lng:12.38,city:"Leipzig"},"06":{lat:51.48,lng:11.97,city:"Halle"},"07":{lat:50.93,lng:11.59,city:"Jena"},"08":{lat:50.72,lng:12.49,city:"Zwickau"},"09":{lat:50.83,lng:12.92,city:"Chemnitz"},10:{lat:52.52,lng:13.41,city:"Berlin Mitte"},12:{lat:52.45,lng:13.43,city:"Berlin Süd"},13:{lat:52.57,lng:13.35,city:"Berlin Nord"},14:{lat:52.39,lng:13.07,city:"Potsdam"},15:{lat:52.34,lng:14.55,city:"Frankfurt/Oder"},16:{lat:52.98,lng:13.79,city:"Oranienburg"},17:{lat:53.91,lng:13.38,city:"Greifswald"},18:{lat:54.09,lng:12.14,city:"Rostock"},19:{lat:53.63,lng:11.41,city:"Schwerin"},20:{lat:53.55,lng:10,city:"Hamburg"},21:{lat:53.47,lng:9.78,city:"Hamburg Süd"},22:{lat:53.6,lng:10.05,city:"Hamburg Nord"},23:{lat:53.87,lng:10.69,city:"Lübeck"},24:{lat:54.32,lng:10.14,city:"Kiel"},25:{lat:53.87,lng:9.09,city:"Itzehoe"},26:{lat:53.14,lng:8.22,city:"Oldenburg"},27:{lat:53.08,lng:8.81,city:"Bremen Nord"},28:{lat:53.08,lng:8.81,city:"Bremen"},29:{lat:52.97,lng:10.57,city:"Celle"},30:{lat:52.37,lng:9.74,city:"Hannover"},31:{lat:52.23,lng:9.52,city:"Hannover Süd"},32:{lat:52.02,lng:8.53,city:"Herford"},33:{lat:51.93,lng:8.38,city:"Bielefeld"},34:{lat:51.31,lng:9.5,city:"Kassel"},35:{lat:50.56,lng:8.67,city:"Gießen"},36:{lat:50.55,lng:9.68,city:"Fulda"},37:{lat:51.53,lng:9.93,city:"Göttingen"},38:{lat:52.27,lng:10.52,city:"Braunschweig"},39:{lat:52.13,lng:11.63,city:"Magdeburg"},40:{lat:51.23,lng:6.78,city:"Düsseldorf"},41:{lat:51.19,lng:6.44,city:"Mönchengladbach"},42:{lat:51.26,lng:7.15,city:"Wuppertal"},44:{lat:51.51,lng:7.47,city:"Dortmund"},45:{lat:51.45,lng:7.01,city:"Essen"},46:{lat:51.54,lng:6.77,city:"Oberhausen"},47:{lat:51.43,lng:6.76,city:"Duisburg"},48:{lat:51.96,lng:7.63,city:"Münster"},49:{lat:52.28,lng:8.05,city:"Osnabrück"},50:{lat:50.94,lng:6.96,city:"Köln"},51:{lat:50.99,lng:7.13,city:"Köln Ost"},52:{lat:50.78,lng:6.08,city:"Aachen"},53:{lat:50.73,lng:7.1,city:"Bonn"},54:{lat:49.75,lng:6.64,city:"Trier"},55:{lat:50,lng:8.27,city:"Mainz"},56:{lat:50.36,lng:7.6,city:"Koblenz"},57:{lat:50.87,lng:8.02,city:"Siegen"},58:{lat:51.36,lng:7.47,city:"Hagen"},59:{lat:51.66,lng:8.38,city:"Hamm"},60:{lat:50.11,lng:8.68,city:"Frankfurt"},61:{lat:50.22,lng:8.62,city:"Frankfurt Nord"},63:{lat:50,lng:8.96,city:"Offenbach"},64:{lat:49.87,lng:8.65,city:"Darmstadt"},65:{lat:50.08,lng:8.24,city:"Wiesbaden"},66:{lat:49.24,lng:7,city:"Saarbrücken"},67:{lat:49.45,lng:8.44,city:"Ludwigshafen"},68:{lat:49.49,lng:8.47,city:"Mannheim"},69:{lat:49.41,lng:8.69,city:"Heidelberg"},70:{lat:48.78,lng:9.18,city:"Stuttgart"},71:{lat:48.73,lng:9.11,city:"Stuttgart Süd"},72:{lat:48.52,lng:9.05,city:"Tübingen"},73:{lat:48.8,lng:9.47,city:"Esslingen"},74:{lat:49.14,lng:9.22,city:"Heilbronn"},75:{lat:48.89,lng:8.69,city:"Pforzheim"},76:{lat:49.01,lng:8.4,city:"Karlsruhe"},77:{lat:48.47,lng:7.94,city:"Offenburg"},78:{lat:47.99,lng:8.52,city:"Villingen"},79:{lat:47.99,lng:7.85,city:"Freiburg"},80:{lat:48.14,lng:11.58,city:"München"},81:{lat:48.11,lng:11.6,city:"München Süd"},82:{lat:48.05,lng:11.47,city:"München West"},83:{lat:47.86,lng:11.97,city:"Rosenheim"},84:{lat:48.44,lng:12.12,city:"Landshut"},85:{lat:48.4,lng:11.74,city:"Freising"},86:{lat:48.37,lng:10.9,city:"Augsburg"},87:{lat:47.73,lng:10.31,city:"Kempten"},88:{lat:47.66,lng:9.48,city:"Friedrichshafen"},89:{lat:48.4,lng:10,city:"Ulm"},90:{lat:49.45,lng:11.08,city:"Nürnberg"},91:{lat:49.6,lng:11.01,city:"Erlangen"},92:{lat:49.02,lng:12.1,city:"Amberg"},93:{lat:49.02,lng:12.1,city:"Regensburg"},94:{lat:48.57,lng:13.45,city:"Passau"},95:{lat:50.06,lng:11.78,city:"Bayreuth"},96:{lat:50.1,lng:10.88,city:"Bamberg"},97:{lat:49.79,lng:9.95,city:"Würzburg"},98:{lat:50.68,lng:10.93,city:"Suhl"},99:{lat:50.98,lng:11.03,city:"Erfurt"}};function ft(e,t,n,s){const a=ce(n-e),r=ce(s-t),o=Math.sin(a/2)*Math.sin(a/2)+Math.cos(ce(e))*Math.cos(ce(n))*Math.sin(r/2)*Math.sin(r/2);return 6371*(2*Math.atan2(Math.sqrt(o),Math.sqrt(1-o)))}function ce(e){return e*(Math.PI/180)}let Ee=0;const Ve=1e3;async function H(e){var s;if(!e||e.length<2)return null;const t=e.replace(/\D/g,"").substring(0,5);if(t.length<5)return Ze(t);const n=xt(t);if(n)return n;try{const i=Date.now();i-Ee<Ve&&await new Promise(o=>setTimeout(o,Ve-(i-Ee))),Ee=Date.now(),console.log(`🌐 Lade PLZ ${t} von OpenStreetMap...`);const a=await fetch(`https://nominatim.openstreetmap.org/search?format=json&country=DE&postalcode=${t}&limit=1`,{headers:{"User-Agent":"SwaF Tandem Matcher v2.0"}});if(!a.ok)throw new Error(`HTTP ${a.status}`);const r=await a.json();if(r&&r.length>0){const o={lat:parseFloat(r[0].lat),lng:parseFloat(r[0].lon),city:((s=r[0].display_name)==null?void 0:s.split(",")[0])||void 0};return ht(t,o),console.log(`✅ PLZ ${t} gefunden:`,o),o}}catch(i){console.warn(`⚠️ Nominatim API Fehler für PLZ ${t}:`,i)}return Ze(t)}function Ze(e){const t=e.substring(0,2),n=qt[t];if(!n)return null;console.log(`📍 Verwende statische Regionsdaten für PLZ ${e}`);const s={lat:n.lat,lng:n.lng,city:n.city};return ht(e,s),s}async function Rt(e,t){if(e===t)return 0;const n=await H(e),s=await H(t);if(!(!n||!s))return ft(n.lat,n.lng,s.lat,s.lng)}const le=new Map;async function Nt(e,t){if(!e||!t)return null;if(e===t)return{distanceKm:0,drivingMinutes:0,transitMinutes:0,cyclingMinutes:0,walkingMinutes:0};const n=`${e}-${t}`,s=le.get(n);if(s)return s;const i=`${t}-${e}`,a=le.get(i);if(a)return a;const r=await H(e),o=await H(t);if(!r||!o)return null;try{const m=`https://router.project-osrm.org/route/v1/driving/${r.lng},${r.lat};${o.lng},${o.lat}?overview=false`;console.log(`🚗 Berechne Entfernung ${e} → ${t}...`);const g=await fetch(m);if(!g.ok)throw new Error(`HTTP ${g.status}`);const b=await g.json();if(b.code==="Ok"&&b.routes&&b.routes.length>0){const y=b.routes[0],I=y.distance/1e3,F=Math.round(y.duration/60),re=Math.round(F*1.8),ae=Math.round(I*4),oe=Math.round(I*12),j={distanceKm:Math.round(I*10)/10,drivingMinutes:F,transitMinutes:re,cyclingMinutes:ae,walkingMinutes:oe};return le.set(n,j),console.log(`✅ Entfernung: ${j.distanceKm} km`),j}}catch(m){console.warn("⚠️ OSRM API Fehler:",m)}const c=ft(r.lat,r.lng,o.lat,o.lng),d=Math.round(c*1.3*10)/10,u={distanceKm:d,drivingMinutes:Math.round(d*1.2),transitMinutes:Math.round(d*2.2),cyclingMinutes:Math.round(d*4),walkingMinutes:Math.round(d*12)};return le.set(n,u),u}function _t(e){if(e.distanceKm===0)return"Gleiche PLZ";const t=[];return t.push(`${e.distanceKm} km Entfernung`),e.drivingMinutes<=120&&t.push(`ca. ${ke(e.drivingMinutes)} mit Auto`),e.transitMinutes<=180&&t.push(`ca. ${ke(e.transitMinutes)} mit ÖPNV`),e.walkingMinutes<=45&&t.push(`ca. ${ke(e.walkingMinutes)} zu Fuß`),t.join(", ")}function ke(e){if(e<60)return`${e} min`;const t=Math.floor(e/60),n=e%60;return n===0?`${t} h`:`${t}:${n.toString().padStart(2,"0")} h`}function Dt(e,t){const n=`https://www.google.com/maps/dir/${e.lat},${e.lng}/${t.lat},${t.lng}`,s=`https://www.bvg.de/de/verbindungen/verbindungssuche?start=${e.lat},${e.lng}&destination=${t.lat},${t.lng}`;return{google:n,bvg:s,mvv:"https://www.mvv-muenchen.de/fahrplanauskunft/index.html#routing",hvv:"https://www.hvv.de/de/fahrplaene/abruf-fahrplaninfos/"}}let M=null,_=new Map,Re=null;function Ot(){document.getElementById("map")&&(M=L.map("map").setView([51.1657,10.4515],6),L.tileLayer("https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png",{attribution:'&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a>',maxZoom:18}).addTo(M),Je(),window.addEventListener("profiles-updated",Je),window.addEventListener("tandems-updated",Ft),window.addEventListener("profile-selected",t=>{Kt(t.detail.profileId)}),window.addEventListener("profile-deselected",()=>{Wt()}))}function Ft(){const e=ve();_.forEach((t,n)=>{var i;const s=(i=t.getElement())==null?void 0:i.querySelector(".marker-icon");s&&(e.has(n)?s.classList.add("matched"):s.classList.remove("matched"))})}async function Je(){if(!M)return;_.forEach(n=>n.remove()),_.clear();const e=we(),t=new Map;for(const n of e){const s=O(n);s&&(t.has(s)||t.set(s,[]),t.get(s).push(n))}for(const[n,s]of t){const i=await H(n);if(!(!i||!isFinite(i.lat)||!isFinite(i.lng)))for(let a=0;a<s.length;a++){const r=s[a],o=Gt(a,s.length),c=i.lat+o.lat,l=i.lng+o.lng,d=Ht(r,c,l);d.addTo(M),_.set(r.id,d)}}}function Gt(e,t){if(t===1)return{lat:0,lng:0};const n=.002,s=.001*Math.floor(e/8),i=n+s,r=e*2.399963;return{lat:i*Math.cos(r),lng:i*Math.sin(r)*1.4}}function Ht(e,t,n){const s=ne(e),i=e.name.split(" ").map(u=>u[0]).join("").substring(0,2).toUpperCase(),r=ve().has(e.id),o=r?"matched":"",c=L.divIcon({className:"marker-wrapper",html:`<div class="marker-icon ${s} ${o}" data-profile-id="${e.id}">${i}</div>`,iconSize:[30,30],iconAnchor:[15,15]}),l=L.marker([t,n],{icon:c}),d=jt(e,s,r);return l.bindPopup(d,{maxWidth:300}),l.on("click",()=>{window.dispatchEvent(new CustomEvent("profile-clicked",{detail:{profileId:e.id}}))}),l}function jt(e,t,n=!1){const s=Q(e),i=O(e),a=ue(e),r=$e(e,["hobby","hobbies","freizeit","interessen"]),o=$e(e,["sprache","sprachen","language"]),c=$e(e,["beruf","arbeit","job","tätigkeit","beschäftigung"]),l=a==="male"?"M":a==="female"?"W":a==="other"?"D":"",d=t==="local"?"Local":"Newcomer",u=t==="local"?"local":"newcomer";let m=`
  ...
  `,m}function Le(e,t){return e.length<=t?e:e.substring(0,t-3)+"..."}function ee(e){const t=document.createElement("div");return t.textContent=e,t.innerHTML}function $e(e,t){for(const n of t){const s=new RegExp(n,"i"),i=e.fields.find(a=>s.test(a.question));if(i!=null&&i.answer)return i.answer}return null}function Kt(e){Re=e,_.forEach((n,s)=>{var a;const i=(a=n.getElement())==null?void 0:a.querySelector(".marker-icon");i&&i.classList.toggle("selected",s===e)});const t=_.get(e);t&&M&&M.setView(t.getLatLng(),Math.max(M.getZoom(),10))}function Wt(){Re=null,_.forEach(e=>{var n;const t=(n=e.getElement())==null?void 0:n.querySelector(".marker-icon");t&&t.classList.remove("selected","compatible","incompatible","top-match")})}function Ut(e,t,n){_.forEach((s,i)=>{var r;if(i===Re)return;const a=(r=s.getElement())==null?void 0:r.querySelector(".marker-icon");a&&(a.classList.remove("compatible","incompatible","top-match"),n.includes(i)?a.classList.add("compatible","top-match"):e.includes(i)?a.classList.add("compatible"):t.includes(i)&&a.classList.add("incompatible"))})}function Vt(){M&&setTimeout(()=>{M==null||M.invalidateSize()},100)}window.addEventListener("map-needs-resize",Vt);let S={},w=new Set,D=!1;function Zt(){x(),Jt();const e=document.getElementById("filter-gender"),t=document.getElementById("filter-group"),n=document.getElementById("filter-search");e==null||e.addEventListener("change",()=>{S.gender=e.value,x()}),t==null||t.addEventListener("change",()=>{S.group=t.value,x()}),n==null||n.addEventListener("input",()=>{S.searchText=n.value,x()}),window.addEventListener("profiles-updated",x),window.addEventListener("tandems-updated",x),window.addEventListener("profile-clicked",s=>{gt(s.detail.profileId)})}function Jt(){const e=document.querySelector(".sidebar-header");if(!e||document.getElementById("manualMatchBtn"))return;const t=document.createElement("button");t.id="manualMatchBtn",t.className="btn btn-sm",t.innerHTML="👆 Manuell matchen",t.title="Zwei Profile zum Matchen auswählen",t.addEventListener("click",()=>{D=!D,w.clear(),window.dispatchEvent(new CustomEvent("profile-deselected")),xe(),x()}),e.appendChild(t)}function xe(){const e=document.getElementById("manualMatchBtn");e&&(D?(e.classList.add("active"),e.innerHTML=w.size===0?"✋ Wähle 2 Profile...":w.size===1?"✋ Noch 1 wählen...":"✅ Matchen!"):(e.classList.remove("active"),e.innerHTML="👆 Manuell matchen"))}function x(){const e=document.getElementById("profileList"),t=document.getElementById("profileCount");if(!e)return;const n=Qt();if(t&&(t.textContent=String(n.length)),n.length===0){e.innerHTML='<p class="empty-state">Keine Profile gefunden. Importiere Profile über den Button oben.</p>';return}e.innerHTML=n.map(s=>Yt(s)).join(""),e.querySelectorAll(".profile-card").forEach(s=>{s.addEventListener("click",()=>{const i=s.getAttribute("data-profile-id");i&&gt(i)})})}function Qt(){let e=we();if(S.gender&&S.gender!=="all"&&(e=e.filter(t=>ue(t)===S.gender)),S.group&&S.group!=="all"&&(e=e.filter(t=>ne(t)===S.group)),S.searchText){const t=S.searchText.toLowerCase();e=e.filter(n=>{const s=O(n)||"";return n.name.toLowerCase().includes(t)||s.includes(t)})}return e}function Yt(e){const t=O(e)||"-",n=ne(e),s=Q(e),i=w.has(e.id),r=ve().has(e.id),o=r?V(e.id):null,c=o?o.profile1.id===e.id?o.profile2.name:o.profile1.name:null,l=D&&i?Array.from(w).indexOf(e.id)+1:0;return`
  ...
  `}function gt(e){const t=de(e);if(!t)return;const n=V(e);if(n&&!D){window.dispatchEvent(new CustomEvent("edit-tandem",{detail:{tandemId:n.id,tandem:n,profileId:e}}));return}if(D){if(w.has(e))w.delete(e);else{if(w.size>=2){const s=Array.from(w)[0];w.delete(s)}w.add(e)}if(xe(),w.size===2){const s=Array.from(w),i=de(s[0]),a=de(s[1]);if(i&&a){const r=V(i.id),o=V(a.id);if(r||o){alert("Eines der Profile ist bereits in einem Tandem. Bitte zuerst das bestehende Tandem auflösen.");return}window.dispatchEvent(new CustomEvent("create-match",{detail:{profile1:i,profile2:a}})),D=!1,w.clear(),xe()}}x();return}if(w.has(e))w.delete(e),window.dispatchEvent(new CustomEvent("profile-deselected",{detail:{profileId:e}}));else{if(w.size>0){const s=Array.from(w)[0];w.clear(),window.dispatchEvent(new CustomEvent("profile-deselected",{detail:{profileId:s}}))}w.add(e),window.dispatchEvent(new CustomEvent("profile-selected",{detail:{profileId:e,profile:t}}))}x()}function Qe(e){const t=document.createElement("div");return t.textContent=e,t.innerHTML}const Xt=["vorname","nachname","name","vollständiger name","e-mail-adresse","e-mail","email","telefonnummer","telefon","id","user-id","teilnehmer-id","profil-id","gruppe","standort","region","west","ost","nord","süd","vermittler","vermittler*in","durchgeführt von","durchgeführt","datum/uhrzeit","datum","uhrzeit","termin","terminart","status","bearbeitungsstatus","anmeldestatus","infoabend","infonachmittag","format","aufnahmegespräch","standort-newsletter","newsletter","dsgvo","einverständnis","notizen","interne notizen","bemerkungen admin","url","link","portal-link","wie wirkt die person auf dich","eindruck","bewertung","wie schätzt du ein","einschätzung","beurteilung","sind weitere schritte nötig","nächste schritte","follow-up","aufnahmegespräch datum","gespräch datum","plz","postleitzahl","ort","stadt","köln","berlin","münchen","ausgeschlossen","ausgetreten","pausiert","vermittelt","unvermittelt","angemeldet","beginn","ende"];function en(e){const t=e.toLowerCase().trim();return t.length<3||t==="geschlecht"||t==="dein geschlecht"?!0:Xt.some(n=>t.includes(n)||n.includes(t))}function v(e,t){for(const n of t){const s=new RegExp(n,"i"),i=e.fields.find(a=>s.test(a.question)&&!en(a.question));if(i!=null&&i.answer)return i.answer}return null}function Ne(e,t){const n=[],s=ne(e),i=ne(t);if(s===i)return{compatible:!1,score:0,failReason:"same_group",failDetails:`Beide sind ${s==="local"?"Locals":"Newcomer"} - nur interkulturelle Matches möglich`,softFactsScore:0,softFactsMax:15};const a=tn(e,t);if(!a.pass)return{compatible:!1,score:0,failReason:"age_preference",failDetails:a.reason,softFactsScore:0,softFactsMax:15};const r=nn(e,t);if(!r.pass)return{compatible:!1,score:0,failReason:"gender_preference",failDetails:r.reason,softFactsScore:0,softFactsMax:15};const o=sn(e,t);if(!o.pass)return{compatible:!1,score:0,failReason:"time_overlap",failDetails:o.reason,softFactsScore:0,softFactsMax:15};const c=[],l=rn(e,t,n,c),d=15;return{compatible:!0,score:Math.min(5,Math.round(l/d*5)),softFactsScore:l,softFactsMax:d,details:n.join("; "),positiveFactors:c.slice(0,3)}}function tn(e,t){const n=Q(e),s=Q(t);if(!n||!s)return{pass:!0};const i=Math.abs(n-s),a=v(e,["alter.*unterschied","alter.*tandem","wie groß.*alter"]),r=v(t,["alter.*unterschied","alter.*tandem","wie groß.*alter"]);if(a){const o=a.toLowerCase();if(!o.includes("egal"))if(o.includes("±")||o.includes("+/-")){const c=o.match(/(\d+)/);if(c&&i>parseInt(c[1]))return{pass:!1,reason:`${e.name}: Alterspräferenz "${a}" nicht erfüllt (Diff: ${i} Jahre)`}}else{const c=o.match(/(\d+)\s*jahre?/);if(c&&i>parseInt(c[1]))return{pass:!1,reason:`${e.name}: Alterspräferenz "${a}" nicht erfüllt (Diff: ${i} Jahre)`}}if(o.includes("älter")&&!o.includes("jünger")&&!o.includes("egal")&&s<n)return{pass:!1,reason:`${e.name}: Präferiert älteren Partner`};if(o.includes("jünger")&&!o.includes("älter")&&!o.includes("egal")&&s>n)return{pass:!1,reason:`${e.name}: Präferiert jüngeren Partner`}}if(r){const o=r.toLowerCase();if(!o.includes("egal"))if(o.includes("±")||o.includes("+/-")){const c=o.match(/(\d+)/);if(c&&i>parseInt(c[1]))return{pass:!1,reason:`${t.name}: Alterspräferenz "${r}" nicht erfüllt (Diff: ${i} Jahre)`}}else{const c=o.match(/(\d+)\s*jahre?/);if(c&&i>parseInt(c[1]))return{pass:!1,reason:`${t.name}: Alterspräferenz "${r}" nicht erfüllt (Diff: ${i} Jahre)`}}if(o.includes("älter")&&!o.includes("jünger")&&!o.includes("egal")&&n<s)return{pass:!1,reason:`${t.name}: Präferiert älteren Partner`};if(o.includes("jünger")&&!o.includes("älter")&&!o.includes("egal")&&n>s)return{pass:!1,reason:`${t.name}: Präferiert jüngeren Partner`}}return{pass:!0}}function nn(e,t){const n=ue(e),s=ue(t),i=v(e,["geschlecht.*tandem","geschlecht.*partner"]),a=v(t,["geschlecht.*tandem","geschlecht.*partner"]);if(i&&s){const r=i.toLowerCase();if(!r.includes("egal")&&!r.includes("keine")){if((r.includes("nur frauen")||r.includes("frauen*"))&&s!=="female")return{pass:!1,reason:`${e.name}: Geschlechtspräferenz "${i}" nicht erfüllt`};if((r.includes("nur männer")||r.includes("männer*"))&&s!=="male")return{pass:!1,reason:`${e.name}: Geschlechtspräferenz "${i}" nicht erfüllt`}}}if(a&&n){const r=a.toLowerCase();if(!r.includes("egal")&&!r.includes("keine")){if((r.includes("nur frauen")||r.includes("frauen*"))&&n!=="female")return{pass:!1,reason:`${t.name}: Geschlechtspräferenz "${a}" nicht erfüllt`};if((r.includes("nur männer")||r.includes("männer*"))&&n!=="male")return{pass:!1,reason:`${t.name}: Geschlechtspräferenz "${a}" nicht erfüllt`}}}return{pass:!0}}function sn(e,t){const n=v(e,["zeit.*treffen","zeit.*tandem","wann.*zeit"]),s=v(t,["zeit.*treffen","zeit.*tandem","wann.*zeit"]);if(!n||!s)return{pass:!0};const i=n.toLowerCase(),a=s.toLowerCase();return i.includes("flexibel")||a.includes("flexibel")?{pass:!0}:["morgens","mittags","nachmittags","abends","unter der woche","wochenende"].filter(c=>i.includes(c)&&a.includes(c)).length===0?{pass:!1,reason:"Keine gemeinsamen Zeitfenster gefunden"}:{pass:!0}}function rn(e,t,n,s){let i=0;const a=O(e),r=O(t);if(a&&r){const f=parseInt(a.substring(0,2)),T=parseInt(r.substring(0,2)),R=Math.abs(f-T);a===r?(i+=3,n.push("Gleiche PLZ"),s.push("Gleiche PLZ")):R===0?(i+=2.5,n.push("Gleiche Region (< 10 km)"),s.push("Nah beieinander")):R===1?(i+=2,n.push("Benachbarte Region"),s.push("Benachbarte Region")):R<=3?(i+=1.5,n.push("Nahe Region")):R<=5?i+=1:i+=.5}const o=Q(e),c=Q(t);if(o&&c){const f=Math.abs(o-c);f<=3?(i+=2,n.push(`Sehr ähnliches Alter (±${f} Jahre)`),s.push(f===0?"Gleich alt":`Nur ${f}J Unterschied`)):f<=5?(i+=1.8,n.push(`Ähnliches Alter (±${f} Jahre)`),s.push("Ähnliches Alter")):f<=10?i+=1.5:f<=15?i+=1:f<=20&&(i+=.5)}const l=v(e,["geschlecht.*tandem","geschlecht.*partner"]),d=v(t,["geschlecht.*tandem","geschlecht.*partner"]);(l||d)&&(i+=1,n.push("Geschlechtspräferenz erfüllt")),i+=1,n.push("Interkulturell");const u=v(e,["hobby","hobbies","hobbys"]),m=v(t,["hobby","hobbies","hobbys"]);if(u&&m){const f=an(u,m);if(f.length>0){const T=Math.min(2,f.length*.4);i+=T,f.length>=3?(n.push("Viele gemeinsame Hobbys"),s.push("Viele gemeinsame Hobbys")):f.length>=2?(n.push("Mehrere gemeinsame Hobbys"),s.push("Gemeinsame Hobbys")):n.push("Gemeinsame Hobby-Interessen")}}const g=v(e,["freizeit(?!.*vermittler)"]),b=v(t,["freizeit(?!.*vermittler)"]);if(g&&b){const f=Ye(g,b);f.length>=3?(i+=1.5,n.push("Ähnliche Freizeitinteressen")):f.length>=1&&(i+=.75)}const y=v(e,["themen.*interessieren","interess.*themen"]),I=v(t,["themen.*interessieren","interess.*themen"]);if(y&&I){const f=["politik","kunst","kultur","technologie","sport","musik","natur","reisen","essen","kochen","wissenschaft","geschichte","literatur"],T=y.toLowerCase(),R=I.toLowerCase(),Y=f.filter(X=>T.includes(X)&&R.includes(X));Y.length>=2?(i+=1.5,n.push("Mehrere gemeinsame Interessensgebiete"),s.push("Ähnliche Interessen")):Y.length===1&&(i+=.75,n.push("Gemeinsame Interessensgebiete"))}const F=v(e,["freundschaft.*wichtig","wichtig.*freundschaft"]),re=v(t,["freundschaft.*wichtig","wichtig.*freundschaft"]);if(F&&re){const f=["ehrlichkeit","vertrauen","respekt","toleranz","humor","offenheit","zuverlässigkeit","loyalität","treue"],T=F.toLowerCase(),R=re.toLowerCase(),Y=f.filter(X=>T.includes(X)&&R.includes(X));Y.length>=2?(i+=1.5,n.push("Ähnliche Wertvorstellungen"),s.push("Ähnliche Werte")):Y.length===1&&(i+=.75)}const ae=v(e,["tandem.*vorstellung(?!.*geschlecht)"]),oe=v(t,["tandem.*vorstellung(?!.*geschlecht)"]);if(ae&&oe){const f=Ye(ae,oe);f.length>=2?(i+=1,n.push("Ähnliche Tandem-Vorstellungen")):f.length>=1&&(i+=.5)}const j=v(e,["community-event","event.*unternehmen"]),We=v(t,["community-event","event.*unternehmen"]);if(j&&We){const f=j.toLowerCase(),T=We.toLowerCase();(f.includes("ja")||f.includes("gerne"))&&(T.includes("ja")||T.includes("gerne"))&&(i+=.5)}return i}function an(e,t){const n=e.split(/[,;]/).map(i=>Ue(i.trim())).filter(Boolean),s=t.split(/[,;]/).map(i=>Ue(i.trim())).filter(Boolean);return n.filter(i=>s.some(a=>i===a))}function Ye(e,t){const n=new Set(["und","oder","der","die","das","ein","eine","mit","für","von","zu","ich","mir","mich","gerne","sehr","auch","aber","dass","wenn","weil","nicht","mehr","noch","schon","immer"]),s=e.toLowerCase().split(/\s+/).filter(a=>a.length>3&&!n.has(a)),i=t.toLowerCase().split(/\s+/).filter(a=>a.length>3&&!n.has(a));return s.filter(a=>i.some(r=>a===r||a.includes(r)||r.includes(a)))}let k=null,Z=[];function on(){document.getElementById("smartMatchPanel");const e=document.getElementById("closeSmartMatch");e==null||e.addEventListener("click",()=>{Xe(),window.dispatchEvent(new CustomEvent("profile-deselected"))}),window.addEventListener("profile-selected",async t=>{k=t.detail.profile;const s=V(k.id);if(s){window.dispatchEvent(new CustomEvent("edit-tandem",{detail:{tandemId:s.id,tandem:s,profileId:k.id}})),k=null;return}await cn(),ln(),hn()}),window.addEventListener("profile-deselected",()=>{k=null,Z=[],Xe()})}async function cn(){if(!k)return;const e=we(),t=ve(),n=[];for(const s of e){if(s.id===k.id||t.has(s.id))continue;const i=Ne(k,s),a=O(k),r=O(s);let o,c;a&&r&&(o=await Rt(a,r),o!==void 0&&(c=o<1?"<1 km":`${Math.round(o)} km`)),n.push({profile:s,matchResult:i,distance:o,distanceText:c})}n.sort((s,i)=>s.matchResult.compatible!==i.matchResult.compatible?s.matchResult.compatible?-1:1:s.matchResult.compatible?i.matchResult.score-s.matchResult.score:0),Z=n}function ln(){const e=document.getElementById("smartMatchPanel"),t=document.getElementById("selectedProfileName"),n=document.getElementById("smartMatchContent");!e||!t||!n||!k||(t.textContent=k.name,n.innerHTML=dn(),e.classList.add("visible"),n.querySelectorAll(".match-item").forEach(s=>{s.addEventListener("click",()=>{const i=s.getAttribute("data-profile-id");i&&mn(i)})}))}function Xe(){const e=document.getElementById("smartMatchPanel");e==null||e.classList.remove("visible")}function dn(){if(Z.length===0)return'<p class="empty-state">Keine anderen Profile zum Matchen vorhanden.</p>';const e=Z.filter(s=>s.matchResult.compatible),t=Z.filter(s=>!s.matchResult.compatible);let n="";return e.length>0&&(n+='<div class="match-section"><h4>Passende Matches</h4>',n+=e.map(s=>et(s,!0)).join(""),n+="</div>"),t.length>0&&(n+='<div class="match-section"><h4>Unpassend (Hard Facts)</h4>',n+=t.map(s=>et(s,!1)).join(""),n+="</div>"),n}function et(e,t){const{profile:n,matchResult:s,distanceText:i}=e,a=un(s.score);let r="";if(!t&&s.failReason){const c={age_preference:"🎂",gender_preference:"⚧️",time_overlap:"⏰",same_group:"👥"},l={age_preference:"Alter-Präferenz",gender_preference:"Geschlecht-Präferenz",time_overlap:"Keine Zeit-Überschneidung",same_group:"Gleiche Gruppe"},d=c[s.failReason]||"⚠️",u=l[s.failReason]||s.failReason;let m="";s.failDetails&&(m=`<div class="reason-details">${Se(s.failDetails)}</div>`),r=`
...
Gemeinsamkeit:`;try{const o=await fetch(`${_e}/api/generate`,{method:"POST",headers:De(),body:JSON.stringify({model:i,prompt:a,stream:!1,options:{temperature:.7,num_predict:60}})});if(!o.ok)return console.warn("Ollama API error:",o.status),null;const l=((r=(await o.json()).response)==null?void 0:r.trim())||null;return!l||l==="---"||l.includes("keine Gemeinsamkeit")||l.includes("keine erkennbare")?null:l.replace(/^["']|["']$/g,"").trim()}catch(o){return console.warn("Ollama generation failed:",o),null}}async function yn(e,t){const n=new Map,s=await Oe();if(!s)return console.warn("No Ollama model available"),n;for(let i=0;i<e.length;i++){const a=e[i];if(t==null||t(i+1,e.length),!a.answer1||!a.answer2)continue;const r=await vt(a.question,a.answer1,a.answer2,s);r&&n.set(a.question,r),await new Promise(o=>setTimeout(o,100))}return n}async function bt(){if(!await pt())return{available:!1,model:null,models:[]};const t=await wt();return{available:!0,model:await Oe(),models:t}}let p=[],B="",q="",C=new Set;const En='Schreibe hierzu einen kurzen Text. Die Frage zu den Antworten lautet {Frage}. Schreibe, wie die Antworten zusammenpassen könnten bzw. gebe Beispiele aus. Hier die Antworten: Person 1 - {Antwort1}, Person 2 - {Antwort2}. Schreibe den Text nach diesem Beispiel: "Ihr habt beide angegeben, dass ihr gerne kocht - ob mit Freund*innen oder alleine. Also los! Probiert doch einmal gemeinsam neue Rezepte. Außerdem geht ihr beide gerne Spazieren. Nach dem Essen sollst du Ruhn, oder 1.000 Schritte tun. Also habt ihr ja quasi schon einen Tagesplan ;) Weil ihr beide gerne auch kulturelle Dinge macht, wie in das Theater/Museum/oder auf andere Kulturveranstaltungen geht - schaut doch mal auf rausgegangen.de was es in Köln so die nächsten Tage gibt. Oder guckt bei uns im Eventportal: www.startwithafriend.de/events" - Nenne KEINE Namen oder andere Personenbezeichnungen.',Pe=["Person","Sprachen & Herkunft","Beruf & Bildung","Hobbys & Interessen","Tandem-Wünsche","Verfügbarkeit","Sonstiges"],kn=["vermittler","durchgeführt von","status","terminart","anmeldestatus","bearbeitungsstatus","infoabend","infonachmittag","aufnahmegespräch datum","newsletter","dsgvo","einverständnis","notizen","interne notizen","bemerkungen admin","url","link","wie wirkt die person","eindruck","einschätzung","bewertung","nächste schritte","follow-up","user-id","profil-id","teilnehmer-id","women_kpi","kpi","integrationskurs","besuchst du gerade einen integrationskurs","vorgeschlagene termine","suggested_appointments","telefonnummer","phone_number","telefon","responsible_user","responsible","registration_interview","appointment_type","appointment_info","region","department_region","department","process_history","process_current_step","flucht","einwandungserfahrung","immigration_experience","create_uid","existing_tandem_count","tandem_count","birthday","geburtstag","geburtsdatum","group","gruppe","e-mail","email","e-mail-adresse","emailadresse","nachname","last_name","lastname","familienname","full_name","fullname","vollständiger name","datum/uhrzeit","datum uhrzeit","anmeldedatum","registrierungsdatum"],Ln=["name","full name"];function $n(e){const t=e.toLowerCase();return t.includes("name")||t.includes("alter")||t.includes("geschlecht")||t.includes("geboren")||t.includes("plz")||t.includes("postleitzahl")?"Person":t.includes("sprache")||t.includes("herkunft")||t.includes("land")||t.includes("deutschland")||t.includes("seit wann")?"Sprachen & Herkunft":t.includes("beruf")||t.includes("arbeit")||t.includes("studium")||t.includes("studiert")||t.includes("abschluss")||t.includes("branche")||t.includes("was machst du gerade")||t.includes("was hast du vorher gemacht")||t.includes("was hast du gelernt")||t.includes("in zukunft")||t.includes("zukunft gerne machen")?"Beruf & Bildung":t.includes("hobby")||t.includes("freizeit")||t.includes("interesse")||t.includes("ausprobieren")||t.includes("was machst du gerne")||t.includes("freundschaft")||t.includes("wichtig")||t.includes("event")||t.includes("anbieten")||t.includes("themen")||t.includes("community")||t.includes("unternehmen")?"Hobbys & Interessen":t.includes("tandem")||t.includes("swaf")||t.includes("mitmachen")||t.includes("warum")||t.includes("vorstellung")||t.includes("geschlecht")&&t.includes("partner")?"Tandem-Wünsche":t.includes("zeit")||t.includes("treffen")||t.includes("wann")||t.includes("erreichen")||t.includes("kontakt")||t.includes("bewegst")?"Verfügbarkeit":"Sonstiges"}function Sn(e){const t=e.toLowerCase().trim();return Ln.includes(t)?!0:kn.some(n=>t.includes(n))}function Ae(e){return e?["übersprungen","keine angabe","k.a.","n/a","-","","egal","keine","null","undefined"].includes(e.toLowerCase().trim()):!0}const Mn=["name","vorname","nachname","plz","postleitzahl","standort","ort","adresse","wohnort","geschlecht","gender","alter","age","geburt","in deutschland geboren","in welchem land","herkunftsland","geburtsland","woher kommst du","country","altersunterschied","geschlechterpräferenz","alterspräferenz"];function In(e){const t=e.toLowerCase();return Mn.some(n=>t.includes(n))}function yt(e,t,n){B=it(t.name),q=it(n.name);const s=new Map;function i(r,o,c){if(Sn(r)||!o||Ae(o))return;const l=Cn(r),d=s.get(l);d?(c?d.answer1?d.answer1!==o&&(d.answer1+="; "+o):d.answer1=o:d.answer2?d.answer2!==o&&(d.answer2+="; "+o):d.answer2=o,d.mergedQuestions.includes(r)||d.mergedQuestions.push(r)):s.set(l,{displayQuestion:r,answer1:c?o:"",answer2:c?"":o,mergedQuestions:[r]})}for(const r of t.fields)i(r.question,r.answer||"",!0);for(const r of n.fields)i(r.question,r.answer||"",!1);p=[];let a=0;for(const[r,o]of s){if(!o.answer1&&!o.answer2)continue;const c=xn(r,o.displayQuestion),l=he(c,o.answer1,o.answer2),d=l.length>0||o.answer1&&o.answer2;p.push({id:`row-${a}`,question:c,answer1:o.answer1,answer2:o.answer2,comment:l,selected:!1,included:d,collapsed:!d,category:$n(c)}),a++}p.sort((r,o)=>{const c=Pe.indexOf(r.category),l=Pe.indexOf(o.category);return c!==l?c-l:r.included!==o.included?r.included?-1:1:r.question.localeCompare(o.question)}),C.clear(),me(e);for(const r of p)(r.question.toLowerCase().includes("plz")||r.question.toLowerCase().includes("postleitzahl"))&&r.answer1&&r.answer2&&Dn(r.answer1,r.answer2,r.id)}const Tn=[{key:"alter",patterns:["alter","age","wie alt bist du","wie alt","dein alter","geburtsjahr"]},{key:"geschlecht",patterns:["geschlecht","gender","dein geschlecht","welches geschlecht"]},{key:"altersunterschied",patterns:["altersunterschied","alterspräferenz","age_difference","max_age_difference","maximaler altersunterschied","altersunterschied zum tandempartner"]},{key:"geschlechterpräferenz",patterns:["geschlechterpräferenz","gender_preference","geschlecht des tandems","geschlecht tandempartner","welches geschlecht soll","gewünschtes geschlecht"]},{key:"vorname",patterns:["vorname","firstname","first_name","first name"]},{key:"plz",patterns:["plz","postleitzahl","postal code","zip","zipcode","deine plz"]},{key:"hobbys",patterns:["hobbys","hobbies","hobby"]},{key:"freizeit",patterns:["freizeit","freizeitaktivitäten"]},{key:"interessen",patterns:["interessen","interests"]},{key:"sprachen",patterns:["sprachen","languages","sprache","welche sprachen sprichst du","welche sprachen"]},{key:"herkunftsland",patterns:["herkunftsland","herkunft","woher kommst du","aus welchem land","country"]},{key:"seit_wann_deutschland",patterns:["seit wann in deutschland","seit wann bist du in deutschland","wie lange in deutschland","in deutschland seit"]}],st={vorname:"Vorname",alter:"Alter",geschlecht:"Geschlecht",plz:"PLZ",hobbys:"Hobbys",freizeit:"Freizeitaktivitäten",interessen:"Interessen",sprachen:"Sprachen",herkunftsland:"Herkunftsland",seit_wann_deutschland:"Seit wann in Deutschland",altersunterschied:"Maximaler Altersunterschied",geschlechterpräferenz:"Geschlecht des Tandempartners"};function Cn(e){const t=e.toLowerCase().replace(/[?!.,:*_-]/g," ").replace(/\s+/g," ").trim(),n=[...Tn].sort((s,i)=>{const a=Math.max(...s.patterns.map(o=>o.length));return Math.max(...i.patterns.map(o=>o.length))-a});for(const s of n)for(const i of s.patterns)if(t===i||t.startsWith(i+" ")||t.endsWith(" "+i)||t.includes(" "+i+" "))return s.key;return t}function xn(e,t){return st[e]?st[e]:t}function me(e){const t=C.size,n=p.filter(i=>i.included).length;p.length-n;const s=new Map;for(const i of p)s.has(i.category)||s.set(i.category,[]),s.get(i.category).push(i);e.innerHTML=`
    <div class="tandem-editor">
      ...
      <div class="editor-table">
        ${Pe.map(i=>{const a=s.get(i);if(!a||a.length===0)return"";const r=a.filter(o=>o.included).length;return`
...
<!--EndFragment-->`,n}function kt(){return p.filter(e=>e.included).map(e=>({question:e.question,answer1:e.answer1,answer2:e.answer2,commonality:e.comment}))}function it(e){if(!e||typeof e!="string")return"Partner*in";const t=e.match(/\(([^)]+)\)/);if(t){const s=t[1].trim().split(/[\s,]+/)[0];if(s&&s.length>1&&!/^(locals?|einwander|interview|gespräch)/i.test(s))return s}if(!/^(aufnahmegespräch|interview|gespräch)/i.test(e)){const n=e.split(/[\s,]+/)[0];if(n&&n.length>1)return n}return"Partner*in"}function h(e){if(!e)return"";const t=document.createElement("div");return t.textContent=e,t.innerHTML}function He(e){if(!e)return null;const t=e.match(/\[🗺️\]\((https?:\/\/[^)]+)\)/);return t?t[1]:null}function ie(e){return e?e.replace(/\s*\[🗺️\]\(https?:\/\/[^)]+\)/,"").trim():""}function Un(e){const t=He(e);return t?`<a href="${t}" target="_blank" class="btn-icon map-link-btn" title="Route in Google Maps öffnen">🗺️</a>`:""}function Vn(e){if(!e)return"";const t=He(e);if(t){const n=ie(e);return`${h(n)} <a href="${t}" target="_blank" class="map-link">🗺️ Route</a>`}return h(e)}function Zn(e){if(!e)return"";const t=He(e);if(t){const n=ie(e);return`${h(n)} <a href="${t}" style="color: #009892;">🗺️ Route anzeigen</a>`}return h(e)}function Jn(){rt(),window.addEventListener("tandems-updated",rt),window.addEventListener("create-match",s=>{const i=s;Xn(i.detail.profile1,i.detail.profile2)}),window.addEventListener("edit-tandem",s=>{ts(s.detail.tandem)});const e=document.getElementById("closeMatchModal"),t=document.getElementById("cancelMatch"),n=document.getElementById("confirmMatch");e==null||e.addEventListener("click",qe),t==null||t.addEventListener("click",qe),n==null||n.addEventListener("click",es)}function rt(){const e=document.getElementById("tandemList");if(!e)return;const t=se();if(t.length===0){e.innerHTML='<p class="empty-state">Noch keine Tandems erstellt. Wähle zwei Profile aus, um ein Tandem zu erstellen.</p>';return}e.innerHTML=t.sort((n,s)=>new Date(s.created).getTime()-new Date(n.created).getTime()).map(n=>Yn(n)).join(""),e.querySelectorAll(".delete-tandem").forEach(n=>{n.addEventListener("click",s=>{s.stopPropagation();const i=n.getAttribute("data-tandem-id");i&&confirm("Tandem wirklich löschen?")&&ut(i)})}),e.querySelectorAll(".copy-tandem").forEach(n=>{n.addEventListener("click",s=>{s.stopPropagation();const i=n.getAttribute("data-tandem-id");i&&Qn(i)})})}function Qn(e){const n=se().find(r=>r.id===e);if(!n)return;if(n.suggestionText){navigator.clipboard.writeText(n.suggestionText).then(()=>{ot("Text kopiert!")}).catch(()=>{alert("Fehler beim Kopieren")});return}const s=at(n.profile1.name),i=at(n.profile2.name);let a=`Hi ${s} und ${i},
...
`}a+=`
Ich freue mich über eure Rückmeldung!
`,navigator.clipboard.writeText(a).then(()=>{ot("Text kopiert!")}).catch(()=>{alert("Fehler beim Kopieren")})}function U(e,t){return e.length>=t?e.substring(0,t):e+" ".repeat(t-e.length)}function Te(e,t){return e?e.length<=t?e:e.substring(0,t-2)+"..":""}function at(e){if(!e||typeof e!="string")return"Partner*in";const t=e.match(/\(([^)]+)\)/);if(t){const s=t[1].trim().split(/[\s,]+/)[0];if(s&&s.length>1&&!/^(locals?|einwander|interview|gespräch)/i.test(s))return s}if(!/^(aufnahmegespräch|interview|gespräch)/i.test(e)){const n=e.split(/[\s,]+/)[0];if(n&&n.length>1)return n}return"Partner*in"}function ot(e){let t=document.getElementById("successToast");t||(t=document.createElement("div"),t.id="successToast",t.className="success-toast",document.body.appendChild(t)),t.textContent=e,t.classList.add("visible"),setTimeout(()=>t==null?void 0:t.classList.remove("visible"),2e3)}function Yn(e){const t=new Date(e.created).toLocaleDateString("de-DE"),n=je(e.matchScore);return`
  ...
  `}function je(e){let t="";for(let n=0;n<5;n++)t+=`<span class="star ${n<e?"":"empty"}">★</span>`;return t}let ge=null;function Xn(e,t){const n=document.getElementById("matchModal"),s=document.getElementById("matchPreview");if(!n||!s)return;ge={profile1:e,profile2:t};const i=Ne(e,t);s.innerHTML=`
    <div class="match-preview-content">
      ...
      <div class="match-score">
        ...
        <span class="stars">${je(i.score)}</span>
      </div>
      <div id="tandemEditorContainer" class="tandem-editor-container">
        <!-- Editor wird hier eingefügt -->
      </div>
    </div>
  `;const a=document.getElementById("tandemEditorContainer");a&&yt(a,e,t),n.classList.add("visible")}function qe(){const e=document.getElementById("matchModal");e==null||e.classList.remove("visible"),ge=null}function es(){if(!ge)return;const{profile1:e,profile2:t}=ge,n=Ne(e,t),s=Ge(),i=kt(),a={id:crypto.randomUUID(),profile1:e,profile2:t,name:`${e.name} & ${t.name}`,created:new Date().toISOString(),commonalities:i,matchScore:n.score,suggestionText:s};It(a),qe(),Ke(`Tandem erstellt: ${e.name} & ${t.name}`)}function Ke(e){let t=document.getElementById("successToast");t||(t=document.createElement("div"),t.id="successToast",t.className="success-toast",document.body.appendChild(t)),t.textContent=e,t.classList.add("visible"),setTimeout(()=>t==null?void 0:t.classList.remove("visible"),3e3)}function z(e){const t=document.createElement("div");return t.textContent=e,t.innerHTML}let N=null;function ts(e){var s,i,a,r;N=e;let t=document.getElementById("editTandemModal");t||(t=document.createElement("div"),t.id="editTandemModal",t.className="modal",t.innerHTML=`
    ...
    `,document.body.appendChild(t),(s=t.querySelector("#closeEditModal"))==null||s.addEventListener("click",pe),(i=t.querySelector("#cancelEditTandem"))==null||i.addEventListener("click",pe),(a=t.querySelector("#dissolveTandem"))==null||a.addEventListener("click",ns),(r=t.querySelector("#saveEditTandem"))==null||r.addEventListener("click",ss));const n=document.getElementById("editTandemContent");if(n){const o=new Date(e.created).toLocaleDateString("de-DE");n.innerHTML=`
      <div class="edit-tandem-info">
        ...
        <div class="tandem-meta">
          <span class="stars">${je(e.matchScore)}</span>
