(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))s(i);new MutationObserver(i=>{for(const a of i)if(a.type==="childList")for(const r of a.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&s(r)}).observe(document,{childList:!0,subtree:!0});function n(i){const a={};return i.integrity&&(a.integrity=i.integrity),i.referrerPolicy&&(a.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?a.credentials="include":i.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function s(i){if(i.ep)return;i.ep=!0;const a=n(i);fetch(i.href,a)}})();const G={PROFILES:"swaf_profiles",TANDEMS:"swaf_tandems",GAMIFICATION:"swaf_gamification_stats",PLZ_CACHE:"swaf_plz_cache",SETTINGS:"swaf_settings"};let T=[],z=[],H=ht(),Q=new Map;function ht(){return{totalMatches:0,todayMatches:0,lastMatchDate:"",streak:0,qualityScores:[],achievements:[],totalPoints:0}}async function Mt(){try{const e=localStorage.getItem(G.PROFILES);e&&(T=JSON.parse(e));const t=localStorage.getItem(G.TANDEMS);t&&(z=JSON.parse(t));const n=localStorage.getItem(G.GAMIFICATION);n&&(H={...ht(),...JSON.parse(n)});const s=localStorage.getItem(G.PLZ_CACHE);if(s){const i=JSON.parse(s);Q=new Map(Object.entries(i))}console.log(`Storage initialized: ${T.length} profiles, ${z.length} tandems`)}catch(e){console.error("Error loading storage:",e)}}function W(){return[...T]}function fe(e){return T.find(t=>t.id===e)}function Tt(e){const t=new Set(T.map(s=>s.id)),n=new Set(T.map(s=>Le(s.name)));for(const s of e){if(t.has(s.id))continue;const i=Le(s.name);if(n.has(i)){const a=T.find(r=>Le(r.name)===i);if(a){Pt(a,s);continue}}T.push(s),t.add(s.id),n.add(i)}Ee()}function Pt(e,t){const n=new Set(e.fields.map(s=>s.question));for(const s of t.fields)n.has(s.question)||e.fields.push(s);e.pageType="Merged",e.timestamp=Math.max(e.timestamp,t.timestamp)}function Le(e){return e.toLowerCase().trim().replace(/\s+/g," ")}function At(e){T=T.filter(t=>t.id!==e),Ee()}function zt(){T=[],Ee()}function Ee(){localStorage.setItem(G.PROFILES,JSON.stringify(T)),window.dispatchEvent(new CustomEvent("profiles-updated"))}function de(){return[...z]}function Ct(e){z.push(e),ke(),H.totalMatches++,H.todayMatches++,H.lastMatchDate=new Date().toISOString().split("T")[0],H.qualityScores.push(e.matchScore),gt()}function ft(e){z=z.filter(t=>t.id!==e),ke()}function xt(e,t){const n=z.findIndex(s=>s.id===e);n!==-1&&(z[n]={...z[n],...t},ke())}function re(){const e=new Set;for(const t of z)e.add(t.profile1.id),e.add(t.profile2.id);return e}function ne(e){return z.find(t=>t.profile1.id===e||t.profile2.id===e)}function ke(){localStorage.setItem(G.TANDEMS,JSON.stringify(z)),window.dispatchEvent(new CustomEvent("tandems-updated"))}function Bt(){return{...H}}function gt(){localStorage.setItem(G.GAMIFICATION,JSON.stringify(H))}function qt(e){return Q.get(e)}function xe(e,t){Q.set(e,t);const n=Object.fromEntries(Q);localStorage.setItem(G.PLZ_CACHE,JSON.stringify(n))}function Dt(e){if(!e.profiles||!Array.isArray(e.profiles))throw new Error("Ungültiges Datenformat");const t=T.length;return Tt(e.profiles),T.length-t}function Rt(){return JSON.stringify({profiles:T,tandems:z,gamificationStats:H,plzCache:Object.fromEntries(Q),exportedAt:new Date().toISOString(),version:"2.0"})}function Ft(e){const t=JSON.parse(e);t.profiles&&(T=t.profiles),t.tandems&&(z=t.tandems),t.gamificationStats&&(H=t.gamificationStats),t.plzCache&&(Q=new Map(Object.entries(t.plzCache))),Ee(),ke(),gt(),localStorage.setItem(G.PLZ_CACHE,JSON.stringify(Object.fromEntries(Q)))}function J(e){const t=e.fields.find(n=>n.question.toLowerCase().includes("plz")||n.question.toLowerCase().includes("postleitzahl"));if(t!=null&&t.answer){const n=t.answer.match(/\d{5}/);return n?n[0]:null}for(const n of e.fields){const s=n.answer.match(/\b\d{5}\b/);if(s)return s[0]}return null}function le(e){const t=[/newcomer/i,/geflüchtet/i,/migrant/i,/zugewandert/i,/immigrant/i,/einwander/i,/neuankommend/i,/geflohene?/i,/refugee/i,/asyl/i,/zuwander/i],n=[/\blocal\b/i,/einheimisch/i,/hier.*geboren/i,/alteingesessen/i,/ortsansässig/i],s=a=>t.some(r=>r.test(a)),i=a=>n.some(r=>r.test(a));if(e.pageType){if(s(e.pageType))return"newcomer";if(i(e.pageType))return"local"}if(e.name){if(s(e.name))return"newcomer";if(i(e.name))return"local"}if(e.url){if(s(e.url))return"newcomer";if(i(e.url))return"local"}for(const a of e.fields){const r=a.question.toLowerCase(),o=a.answer;if(r.includes("gruppe")||r.includes("status")||r.includes("wer bist")||r.includes("local")||r.includes("newcomer")||r.includes("herkunft")||r.includes("aufnahme")||r.includes("teilnehmer")){if(s(o))return"newcomer";if(i(o))return"local"}}for(const a of e.fields)if(s(a.answer))return"newcomer";return"local"}function ae(e){const t=e.fields.find(s=>s.question.toLowerCase().includes("alter")&&!s.question.toLowerCase().includes("unterschied")&&!s.question.toLowerCase().includes("präferenz"));if(t!=null&&t.answer){const s=t.answer.match(/\d+/);if(s){const i=parseInt(s[0]);if(i>=16&&i<=100)return i}}const n=e.fields.find(s=>s.question.toLowerCase().includes("geboren")||s.question.toLowerCase().includes("geburtsjahr"));if(n!=null&&n.answer){const s=n.answer.match(/(19|20)\d{2}/);if(s){const i=parseInt(s[0]),r=new Date().getFullYear()-i;if(r>=16&&r<=100)return r}}return null}function ge(e){const t=e.fields.find(n=>n.question.toLowerCase().includes("geschlecht")&&!n.question.toLowerCase().includes("präferenz")&&!n.question.toLowerCase().includes("partner"));if(t!=null&&t.answer){const n=t.answer.toLowerCase();if(n.includes("männlich")||n.includes("mann")||n==="m")return"male";if(n.includes("weiblich")||n.includes("frau")||n==="w"||n==="f")return"female";if(n.includes("divers")||n.includes("sonstig")||n.includes("andere"))return"other"}return null}const Nt={sport:["sport","fitness","training","gym","workout"],fussball:["fußball","fussball","soccer","kicken"],musik:["musik","music","konzert","singen","instrument"],lesen:["lesen","bücher","reading","books"],kochen:["kochen","cooking","backen","küche"],reisen:["reisen","travel","urlaub","reise"],kino:["kino","filme","movies","cinema","film"],gaming:["gaming","videospiele","spiele","zocken","games"],wandern:["wandern","hiking","spazieren","natur"],fotografie:["fotografie","photography","fotos","fotografieren"],kunst:["kunst","art","malen","zeichnen","museum"],tanzen:["tanzen","dance","dancing","tanz"],yoga:["yoga","meditation","entspannung"],schwimmen:["schwimmen","swimming","baden"],radfahren:["radfahren","fahrrad","cycling","bike","rad"],laufen:["laufen","joggen","running","jogging"],sprachen:["sprachen","languages","sprachkurs"],essen:["essen","food","kulinarik","restaurant"],feiern:["feiern","party","ausgehen","club","bar"],natur:["natur","nature","garten","pflanzen","outdoor"]};function Je(e){const t=e.toLowerCase().trim();for(const[n,s]of Object.entries(Nt))if(s.some(i=>t.includes(i)))return n;return t.replace(/[^a-zäöüß]/gi,"")}const Ot={"01":{lat:51.05,lng:13.74,city:"Dresden"},"02":{lat:51.15,lng:14.97,city:"Görlitz"},"03":{lat:51.76,lng:14.33,city:"Cottbus"},"04":{lat:51.34,lng:12.38,city:"Leipzig"},"05":{lat:51.22,lng:6.78,city:"Düsseldorf"},"06":{lat:51.48,lng:11.97,city:"Halle"},"07":{lat:50.93,lng:11.59,city:"Jena"},"08":{lat:50.72,lng:12.49,city:"Zwickau"},"09":{lat:50.83,lng:12.92,city:"Chemnitz"},10:{lat:52.52,lng:13.41,city:"Berlin Mitte"},11:{lat:52.52,lng:13.41,city:"Berlin"},12:{lat:52.45,lng:13.43,city:"Berlin Süd"},13:{lat:52.57,lng:13.35,city:"Berlin Nord"},14:{lat:52.39,lng:13.07,city:"Potsdam"},15:{lat:52.34,lng:14.55,city:"Frankfurt/Oder"},16:{lat:52.98,lng:13.79,city:"Oranienburg"},17:{lat:53.91,lng:13.38,city:"Greifswald"},18:{lat:54.09,lng:12.14,city:"Rostock"},19:{lat:53.63,lng:11.41,city:"Schwerin"},20:{lat:53.55,lng:10,city:"Hamburg"},21:{lat:53.47,lng:9.78,city:"Hamburg Süd"},22:{lat:53.6,lng:10.05,city:"Hamburg Nord"},23:{lat:53.87,lng:10.69,city:"Lübeck"},24:{lat:54.32,lng:10.14,city:"Kiel"},25:{lat:53.87,lng:9.09,city:"Itzehoe"},26:{lat:53.14,lng:8.22,city:"Oldenburg"},27:{lat:53.08,lng:8.81,city:"Bremen Nord"},28:{lat:53.08,lng:8.81,city:"Bremen"},29:{lat:52.97,lng:10.57,city:"Celle"},30:{lat:52.37,lng:9.74,city:"Hannover"},31:{lat:52.23,lng:9.52,city:"Hannover Süd"},32:{lat:52.02,lng:8.53,city:"Herford"},33:{lat:51.93,lng:8.38,city:"Bielefeld"},34:{lat:51.31,lng:9.5,city:"Kassel"},35:{lat:50.56,lng:8.67,city:"Gießen"},36:{lat:50.55,lng:9.68,city:"Fulda"},37:{lat:51.53,lng:9.93,city:"Göttingen"},38:{lat:52.27,lng:10.52,city:"Braunschweig"},39:{lat:52.13,lng:11.63,city:"Magdeburg"},40:{lat:51.23,lng:6.78,city:"Düsseldorf"},41:{lat:51.19,lng:6.44,city:"Mönchengladbach"},42:{lat:51.26,lng:7.15,city:"Wuppertal"},43:{lat:51.36,lng:7.35,city:"Hagen"},44:{lat:51.51,lng:7.47,city:"Dortmund"},45:{lat:51.45,lng:7.01,city:"Essen"},46:{lat:51.54,lng:6.77,city:"Oberhausen"},47:{lat:51.43,lng:6.76,city:"Duisburg"},48:{lat:51.96,lng:7.63,city:"Münster"},49:{lat:52.28,lng:8.05,city:"Osnabrück"},50:{lat:50.94,lng:6.96,city:"Köln"},51:{lat:50.99,lng:7.13,city:"Köln Ost"},52:{lat:50.78,lng:6.08,city:"Aachen"},53:{lat:50.73,lng:7.1,city:"Bonn"},54:{lat:49.75,lng:6.64,city:"Trier"},55:{lat:50,lng:8.27,city:"Mainz"},56:{lat:50.36,lng:7.6,city:"Koblenz"},57:{lat:50.87,lng:8.02,city:"Siegen"},58:{lat:51.36,lng:7.47,city:"Hagen"},59:{lat:51.66,lng:8.38,city:"Hamm"},60:{lat:50.11,lng:8.68,city:"Frankfurt"},61:{lat:50.22,lng:8.62,city:"Frankfurt Nord"},62:{lat:50.1,lng:8.77,city:"Bad Homburg"},63:{lat:50,lng:8.96,city:"Offenbach"},64:{lat:49.87,lng:8.65,city:"Darmstadt"},65:{lat:50.08,lng:8.24,city:"Wiesbaden"},66:{lat:49.24,lng:7,city:"Saarbrücken"},67:{lat:49.45,lng:8.44,city:"Ludwigshafen"},68:{lat:49.49,lng:8.47,city:"Mannheim"},69:{lat:49.41,lng:8.69,city:"Heidelberg"},70:{lat:48.78,lng:9.18,city:"Stuttgart"},71:{lat:48.73,lng:9.11,city:"Stuttgart Süd"},72:{lat:48.52,lng:9.05,city:"Tübingen"},73:{lat:48.8,lng:9.47,city:"Esslingen"},74:{lat:49.14,lng:9.22,city:"Heilbronn"},75:{lat:48.89,lng:8.69,city:"Pforzheim"},76:{lat:49.01,lng:8.4,city:"Karlsruhe"},77:{lat:48.47,lng:7.94,city:"Offenburg"},78:{lat:47.99,lng:8.52,city:"Villingen"},79:{lat:47.99,lng:7.85,city:"Freiburg"},80:{lat:48.14,lng:11.58,city:"München"},81:{lat:48.11,lng:11.6,city:"München Süd"},82:{lat:48.05,lng:11.47,city:"München West"},83:{lat:47.86,lng:11.97,city:"Rosenheim"},84:{lat:48.44,lng:12.12,city:"Landshut"},85:{lat:48.4,lng:11.74,city:"Freising"},86:{lat:48.37,lng:10.9,city:"Augsburg"},87:{lat:47.73,lng:10.31,city:"Kempten"},88:{lat:47.66,lng:9.48,city:"Friedrichshafen"},89:{lat:48.4,lng:10,city:"Ulm"},90:{lat:49.45,lng:11.08,city:"Nürnberg"},91:{lat:49.6,lng:11.01,city:"Erlangen"},92:{lat:49.02,lng:12.1,city:"Amberg"},93:{lat:49.02,lng:12.1,city:"Regensburg"},94:{lat:48.57,lng:13.45,city:"Passau"},95:{lat:50.06,lng:11.78,city:"Bayreuth"},96:{lat:50.1,lng:10.88,city:"Bamberg"},97:{lat:49.79,lng:9.95,city:"Würzburg"},98:{lat:50.68,lng:10.93,city:"Suhl"},99:{lat:50.98,lng:11.03,city:"Erfurt"}};function pt(e,t,n,s){const a=me(n-e),r=me(s-t),o=Math.sin(a/2)*Math.sin(a/2)+Math.cos(me(e))*Math.cos(me(n))*Math.sin(r/2)*Math.sin(r/2);return 6371*(2*Math.atan2(Math.sqrt(o),Math.sqrt(1-o)))}function me(e){return e*(Math.PI/180)}let Se=0;const Qe=1e3;async function Y(e){var i;if(!e||e.length<2)return null;const t=e.replace(/\D/g,"").substring(0,5);if(t.length<5)return Ye(t);const n=qt(t);if(n)return n;const s=Ye(t);if(s)return xe(t,s),s;try{const a=Date.now();a-Se<Qe&&await new Promise(c=>setTimeout(c,Qe-(a-Se))),Se=Date.now(),console.log(`🌐 Lade PLZ ${t} von OpenStreetMap...`);const r=await fetch(`https://nominatim.openstreetmap.org/search?format=json&country=DE&postalcode=${t}&limit=1`,{headers:{"User-Agent":"SwaF Tandem Matcher v2.0"}});if(!r.ok)throw new Error(`HTTP ${r.status}`);const o=await r.json();if(o&&o.length>0){const c={lat:parseFloat(o[0].lat),lng:parseFloat(o[0].lon),city:((i=o[0].display_name)==null?void 0:i.split(",")[0])||void 0};return xe(t,c),console.log(`✅ PLZ ${t} gefunden:`,c),c}}catch(a){console.warn(`⚠️ Nominatim API Fehler für PLZ ${t}:`,a)}return null}function Ye(e){const t=e.substring(0,2),n=Ot[t];if(!n)return null;let s=0,i=0;if(e.length>=5){const r=parseInt(e.substring(2,5),10)||0,o=r*2.399963,c=.02+r%100*3e-4;s=c*Math.cos(o),i=c*Math.sin(o)*1.4}const a={lat:n.lat+s,lng:n.lng+i,city:n.city};return xe(e,a),a}async function _t(e,t){if(e===t)return 0;const n=await Y(e),s=await Y(t);if(!(!n||!s))return pt(n.lat,n.lng,s.lat,s.lng)}const he=new Map;async function Gt(e,t){if(!e||!t)return null;if(e===t)return{distanceKm:0,drivingMinutes:0,transitMinutes:0,cyclingMinutes:0,walkingMinutes:0};const n=`${e}-${t}`,s=he.get(n);if(s)return s;const i=`${t}-${e}`,a=he.get(i);if(a)return a;const r=await Y(e),o=await Y(t);if(!r||!o)return null;try{const f=`https://router.project-osrm.org/route/v1/driving/${r.lng},${r.lat};${o.lng},${o.lat}?overview=false`;console.log(`🚗 Berechne Entfernung ${e} → ${t}...`);const b=await fetch(f);if(!b.ok)throw new Error(`HTTP ${b.status}`);const E=await b.json();if(E.code==="Ok"&&E.routes&&E.routes.length>0){const P=E.routes[0],q=P.distance/1e3,m=Math.round(P.duration/60),h=Math.round(m*1.8),p=Math.round(q*4),k=Math.round(q*12),S={distanceKm:Math.round(q*10)/10,drivingMinutes:m,transitMinutes:h,cyclingMinutes:p,walkingMinutes:k};return he.set(n,S),console.log(`✅ Entfernung: ${S.distanceKm} km`),S}}catch(f){console.warn("⚠️ OSRM API Fehler:",f)}const c=pt(r.lat,r.lng,o.lat,o.lng),d=Math.round(c*1.3*10)/10,u={distanceKm:d,drivingMinutes:Math.round(d*1.2),transitMinutes:Math.round(d*2.2),cyclingMinutes:Math.round(d*4),walkingMinutes:Math.round(d*12)};return he.set(n,u),u}function Ht(e){if(e.distanceKm===0)return"Gleiche PLZ";const t=[];return t.push(`${e.distanceKm} km Entfernung`),e.drivingMinutes<=120&&t.push(`ca. ${Ie(e.drivingMinutes)} mit Auto`),e.transitMinutes<=180&&t.push(`ca. ${Ie(e.transitMinutes)} mit ÖPNV`),e.walkingMinutes<=45&&t.push(`ca. ${Ie(e.walkingMinutes)} zu Fuß`),t.join(", ")}function Ie(e){if(e<60)return`${e} min`;const t=Math.floor(e/60),n=e%60;return n===0?`${t} h`:`${t}:${n.toString().padStart(2,"0")} h`}function jt(e,t){const n=`https://www.google.com/maps/dir/${e.lat},${e.lng}/${t.lat},${t.lng}`,s=`https://www.bvg.de/de/verbindungen/verbindungssuche?start=${e.lat},${e.lng}&destination=${t.lat},${t.lng}`;return{google:n,bvg:s,mvv:"https://www.mvv-muenchen.de/fahrplanauskunft/index.html#routing",hvv:"https://www.hvv.de/de/fahrplaene/abruf-fahrplaninfos/"}}let F=null,U=new Map,_e=null;function Kt(){document.getElementById("map")&&(F=L.map("map").setView([51.1657,10.4515],6),L.tileLayer("https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png",{attribution:'&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a>',maxZoom:18}).addTo(F),Xe(),window.addEventListener("profiles-updated",Xe),window.addEventListener("tandems-updated",Vt),window.addEventListener("profile-selected",t=>{Jt(t.detail.profileId)}),window.addEventListener("profile-deselected",()=>{Qt()}))}function Vt(){const e=re();U.forEach((t,n)=>{var i;const s=(i=t.getElement())==null?void 0:i.querySelector(".marker-icon");s&&(e.has(n)?s.classList.add("matched"):s.classList.remove("matched"))})}async function Xe(){if(!F)return;U.forEach(n=>n.remove()),U.clear();const e=W(),t=new Map;for(const n of e){const s=J(n);s&&(t.has(s)||t.set(s,[]),t.get(s).push(n))}for(const[n,s]of t){const i=await Y(n);if(!(!i||!isFinite(i.lat)||!isFinite(i.lng)))for(let a=0;a<s.length;a++){const r=s[a],o=Wt(a,s.length),c=i.lat+o.lat,l=i.lng+o.lng,d=Ut(r,c,l);d.addTo(F),U.set(r.id,d)}}}function Wt(e,t){if(t===1)return{lat:0,lng:0};const n=.002,s=.001*Math.floor(e/8),i=n+s,r=e*2.399963;return{lat:i*Math.cos(r),lng:i*Math.sin(r)*1.4}}function Ut(e,t,n){const s=le(e),i=e.name.split(" ").map(u=>u[0]).join("").substring(0,2).toUpperCase(),r=re().has(e.id),o=r?"matched":"",c=L.divIcon({className:"marker-wrapper",html:`<div class="marker-icon ${s} ${o}" data-profile-id="${e.id}">${i}</div>`,iconSize:[30,30],iconAnchor:[15,15]}),l=L.marker([t,n],{icon:c}),d=Zt(e,s,r);return l.bindPopup(d,{maxWidth:300}),l.on("click",()=>{window.dispatchEvent(new CustomEvent("profile-clicked",{detail:{profileId:e.id}}))}),l}function Zt(e,t,n=!1){const s=ae(e),i=J(e),a=ge(e),r=Me(e,["hobby","hobbies","freizeit","interessen"]),o=Me(e,["sprache","sprachen","language"]),c=Me(e,["beruf","arbeit","job","tätigkeit","beschäftigung"]),l=a==="male"?"M":a==="female"?"W":a==="other"?"D":"",d=t==="local"?"Local":"Newcomer",u=t==="local"?"local":"newcomer";let f=`
  ...
  `;if(n){const b=ne(e.id);if(b){const E=b.profile1.id===e.id?b.profile2.name:b.profile1.name;f+=`<div class="popup-field tandem-info"><strong>Tandem mit:</strong> ${oe(E)}</div>`}}return c&&(f+=`<div class="popup-field"><strong>Beruf:</strong> ${oe($e(c,50))}</div>`),o&&(f+=`<div class="popup-field"><strong>Sprachen:</strong> ${oe($e(o,80))}</div>`),r&&(f+=`<div class="popup-field"><strong>Interessen:</strong> ${oe($e(r,80))}</div>`),f+=`
      <div class="popup-action">
        ${n?"<em>Bereits vermittelt</em>":"<em>Klicken für Smart Match</em>"}
      </div>
    </div>
  `,f}function $e(e,t){return e.length<=t?e:e.substring(0,t-3)+"..."}function oe(e){const t=document.createElement("div");return t.textContent=e,t.innerHTML}function Me(e,t){for(const n of t){const s=new RegExp(n,"i"),i=e.fields.find(a=>s.test(a.question));if(i!=null&&i.answer)return i.answer}return null}function Jt(e){_e=e,U.forEach((n,s)=>{var a;const i=(a=n.getElement())==null?void 0:a.querySelector(".marker-icon");i&&i.classList.toggle("selected",s===e)});const t=U.get(e);t&&F&&F.setView(t.getLatLng(),Math.max(F.getZoom(),10))}function Qt(){_e=null,U.forEach(e=>{var n;const t=(n=e.getElement())==null?void 0:n.querySelector(".marker-icon");t&&t.classList.remove("selected","compatible","incompatible","top-match")})}function Yt(e,t,n){U.forEach((s,i)=>{var r;if(i===_e)return;const a=(r=s.getElement())==null?void 0:r.querySelector(".marker-icon");a&&(a.classList.remove("compatible","incompatible","top-match"),n.includes(i)?a.classList.add("compatible","top-match"):e.includes(i)?a.classList.add("compatible"):t.includes(i)&&a.classList.add("incompatible"))})}function Xt(){F&&setTimeout(()=>{F==null||F.invalidateSize()},100)}window.addEventListener("map-needs-resize",Xt);let R={},I=new Set,Z=!1;function en(){O(),tn();const e=document.getElementById("filter-gender"),t=document.getElementById("filter-group"),n=document.getElementById("filter-search");e==null||e.addEventListener("change",()=>{R.gender=e.value,O()}),t==null||t.addEventListener("change",()=>{R.group=t.value,O()}),n==null||n.addEventListener("input",()=>{R.searchText=n.value,O()}),window.addEventListener("profiles-updated",O),window.addEventListener("tandems-updated",O),window.addEventListener("profile-clicked",s=>{bt(s.detail.profileId)})}function tn(){const e=document.querySelector(".sidebar-header");if(!e||document.getElementById("manualMatchBtn"))return;const t=document.createElement("button");t.id="manualMatchBtn",t.className="btn btn-sm",t.innerHTML="👆 Manuell matchen",t.title="Zwei Profile zum Matchen auswählen",t.addEventListener("click",()=>{Z=!Z,I.clear(),window.dispatchEvent(new CustomEvent("profile-deselected")),Be(),O()}),e.appendChild(t)}function Be(){const e=document.getElementById("manualMatchBtn");e&&(Z?(e.classList.add("active"),e.innerHTML=I.size===0?"✋ Wähle 2 Profile...":I.size===1?"✋ Noch 1 wählen...":"✅ Matchen!"):(e.classList.remove("active"),e.innerHTML="👆 Manuell matchen"))}function O(){const e=document.getElementById("profileList"),t=document.getElementById("profileCount");if(!e)return;const n=nn();if(t&&(t.textContent=String(n.length)),n.length===0){e.innerHTML='<p class="empty-state">Keine Profile gefunden. Importiere Profile über den Button oben.</p>';return}e.innerHTML=n.map(s=>sn(s)).join(""),e.querySelectorAll(".profile-card").forEach(s=>{s.addEventListener("click",()=>{const i=s.getAttribute("data-profile-id");i&&bt(i)})})}function nn(){let e=W();if(R.gender&&R.gender!=="all"&&(e=e.filter(t=>ge(t)===R.gender)),R.group&&R.group!=="all"&&(e=e.filter(t=>le(t)===R.group)),R.searchText){const t=R.searchText.toLowerCase();e=e.filter(n=>{const s=J(n)||"";return n.name.toLowerCase().includes(t)||s.includes(t)})}return e}function sn(e){const t=J(e)||"-",n=le(e),s=ae(e),i=I.has(e.id),r=re().has(e.id),o=r?ne(e.id):null,c=o?o.profile1.id===e.id?o.profile2.name:o.profile1.name:null,l=Z&&i?Array.from(I).indexOf(e.id)+1:0;return`
  ...
  `}function bt(e){const t=fe(e);if(!t)return;const n=ne(e);if(n&&!Z){window.dispatchEvent(new CustomEvent("edit-tandem",{detail:{tandemId:n.id,tandem:n,profileId:e}}));return}if(Z){if(I.has(e))I.delete(e);else{if(I.size>=2){const s=Array.from(I)[0];I.delete(s)}I.add(e)}if(Be(),I.size===2){const s=Array.from(I),i=fe(s[0]),a=fe(s[1]);if(i&&a){const r=ne(i.id),o=ne(a.id);if(r||o){alert("Eines der Profile ist bereits in einem Tandem. Bitte zuerst das bestehende Tandem auflösen.");return}window.dispatchEvent(new CustomEvent("create-match",{detail:{profile1:i,profile2:a}})),Z=!1,I.clear(),Be()}}O();return}if(I.has(e))I.delete(e),window.dispatchEvent(new CustomEvent("profile-deselected",{detail:{profileId:e}}));else{if(I.size>0){const s=Array.from(I)[0];I.clear(),window.dispatchEvent(new CustomEvent("profile-deselected",{detail:{profileId:s}}))}I.add(e),window.dispatchEvent(new CustomEvent("profile-selected",{detail:{profileId:e,profile:t}}))}O()}function et(e){const t=document.createElement("div");return t.textContent=e,t.innerHTML}const rn=["vorname","nachname","name","vollständiger name","e-mail-adresse","e-mail","email","telefonnummer","telefon","id","user-id","teilnehmer-id","profil-id","gruppe","standort","region","west","ost","nord","süd","vermittler","vermittler*in","durchgeführt von","durchgeführt","datum/uhrzeit","datum","uhrzeit","termin","terminart","status","bearbeitungsstatus","anmeldestatus","infoabend","infonachmittag","format","aufnahmegespräch","standort-newsletter","newsletter","dsgvo","einverständnis","notizen","interne notizen","bemerkungen admin","url","link","portal-link","wie wirkt die person auf dich","eindruck","bewertung","wie schätzt du ein","einschätzung","beurteilung","sind weitere schritte nötig","nächste schritte","follow-up","aufnahmegespräch datum","gespräch datum","plz","postleitzahl","ort","stadt","köln","berlin","münchen","ausgeschlossen","ausgetreten","pausiert","vermittelt","unvermittelt","angemeldet","beginn","ende"];function an(e){const t=e.toLowerCase().trim();return t.length<3||t==="geschlecht"||t==="dein geschlecht"?!0:rn.some(n=>t.includes(n)||n.includes(t))}function $(e,t){for(const n of t){const s=new RegExp(n,"i"),i=e.fields.find(a=>s.test(a.question)&&!an(a.question));if(i!=null&&i.answer)return i.answer}return null}function Ge(e,t){const n=[],s=le(e),i=le(t);if(s===i)return{compatible:!1,score:0,failReason:"same_group",failDetails:`Beide sind ${s==="local"?"Locals":"Newcomer"} - nur interkulturelle Matches möglich`,softFactsScore:0,softFactsMax:15};const a=on(e,t);if(!a.pass)return{compatible:!1,score:0,failReason:"age_preference",failDetails:a.reason,softFactsScore:0,softFactsMax:15};const r=cn(e,t);if(!r.pass)return{compatible:!1,score:0,failReason:"gender_preference",failDetails:r.reason,softFactsScore:0,softFactsMax:15};const o=ln(e,t);if(!o.pass)return{compatible:!1,score:0,failReason:"time_overlap",failDetails:o.reason,softFactsScore:0,softFactsMax:15};const c=[],l=dn(e,t,n,c),d=15;return{compatible:!0,score:Math.min(5,Math.round(l/d*5)),softFactsScore:l,softFactsMax:d,details:n.join("; "),positiveFactors:c.slice(0,3)}}function on(e,t){const n=ae(e),s=ae(t);if(!n||!s)return{pass:!0};const i=Math.abs(n-s),a=$(e,["alter.*unterschied","alter.*tandem","wie groß.*alter"]),r=$(t,["alter.*unterschied","alter.*tandem","wie groß.*alter"]);if(a){const o=a.toLowerCase();if(!o.includes("egal"))if(o.includes("±")||o.includes("+/-")){const c=o.match(/(\d+)/);if(c&&i>parseInt(c[1]))return{pass:!1,reason:`${e.name}: Alterspräferenz "${a}" nicht erfüllt (Diff: ${i} Jahre)`}}else{const c=o.match(/(\d+)\s*jahre?/);if(c&&i>parseInt(c[1]))return{pass:!1,reason:`${e.name}: Alterspräferenz "${a}" nicht erfüllt (Diff: ${i} Jahre)`}}if(o.includes("älter")&&!o.includes("jünger")&&!o.includes("egal")&&s<n)return{pass:!1,reason:`${e.name}: Präferiert älteren Partner`};if(o.includes("jünger")&&!o.includes("älter")&&!o.includes("egal")&&s>n)return{pass:!1,reason:`${e.name}: Präferiert jüngeren Partner`}}if(r){const o=r.toLowerCase();if(!o.includes("egal"))if(o.includes("±")||o.includes("+/-")){const c=o.match(/(\d+)/);if(c&&i>parseInt(c[1]))return{pass:!1,reason:`${t.name}: Alterspräferenz "${r}" nicht erfüllt (Diff: ${i} Jahre)`}}else{const c=o.match(/(\d+)\s*jahre?/);if(c&&i>parseInt(c[1]))return{pass:!1,reason:`${t.name}: Alterspräferenz "${r}" nicht erfüllt (Diff: ${i} Jahre)`}}if(o.includes("älter")&&!o.includes("jünger")&&!o.includes("egal")&&n<s)return{pass:!1,reason:`${t.name}: Präferiert älteren Partner`};if(o.includes("jünger")&&!o.includes("älter")&&!o.includes("egal")&&n>s)return{pass:!1,reason:`${t.name}: Präferiert jüngeren Partner`}}return{pass:!0}}function cn(e,t){const n=ge(e),s=ge(t),i=$(e,["geschlecht.*tandem","geschlecht.*partner"]),a=$(t,["geschlecht.*tandem","geschlecht.*partner"]);if(i&&s){const r=i.toLowerCase();if(!r.includes("egal")&&!r.includes("keine")){if((r.includes("nur frauen")||r.includes("frauen*"))&&s!=="female")return{pass:!1,reason:`${e.name}: Geschlechtspräferenz "${i}" nicht erfüllt`};if((r.includes("nur männer")||r.includes("männer*"))&&s!=="male")return{pass:!1,reason:`${e.name}: Geschlechtspräferenz "${i}" nicht erfüllt`}}}if(a&&n){const r=a.toLowerCase();if(!r.includes("egal")&&!r.includes("keine")){if((r.includes("nur frauen")||r.includes("frauen*"))&&n!=="female")return{pass:!1,reason:`${t.name}: Geschlechtspräferenz "${a}" nicht erfüllt`};if((r.includes("nur männer")||r.includes("männer*"))&&n!=="male")return{pass:!1,reason:`${t.name}: Geschlechtspräferenz "${a}" nicht erfüllt`}}}return{pass:!0}}function ln(e,t){const n=$(e,["zeit.*treffen","zeit.*tandem","wann.*zeit"]),s=$(t,["zeit.*treffen","zeit.*tandem","wann.*zeit"]);if(!n||!s)return{pass:!0};const i=n.toLowerCase(),a=s.toLowerCase();return i.includes("flexibel")||a.includes("flexibel")?{pass:!0}:["morgens","mittags","nachmittags","abends","unter der woche","wochenende"].filter(c=>i.includes(c)&&a.includes(c)).length===0?{pass:!1,reason:"Keine gemeinsamen Zeitfenster gefunden"}:{pass:!0}}function dn(e,t,n,s){let i=0;const a=J(e),r=J(t);if(a&&r){const g=parseInt(a.substring(0,2)),A=parseInt(r.substring(0,2)),x=Math.abs(g-A);a===r?(i+=3,n.push("Gleiche PLZ"),s.push("Gleiche PLZ")):x===0?(i+=2.5,n.push("Gleiche Region (< 10 km)"),s.push("Nah beieinander")):x===1?(i+=2,n.push("Benachbarte Region"),s.push("Benachbarte Region")):x<=3?(i+=1.5,n.push("Nahe Region")):x<=5?i+=1:i+=.5}const o=ae(e),c=ae(t);if(o&&c){const g=Math.abs(o-c);g<=3?(i+=2,n.push(`Sehr ähnliches Alter (±${g} Jahre)`),s.push(g===0?"Gleich alt":`Nur ${g}J Unterschied`)):g<=5?(i+=1.8,n.push(`Ähnliches Alter (±${g} Jahre)`),s.push("Ähnliches Alter")):g<=10?i+=1.5:g<=15?i+=1:g<=20&&(i+=.5)}const l=$(e,["geschlecht.*tandem","geschlecht.*partner"]),d=$(t,["geschlecht.*tandem","geschlecht.*partner"]);(l||d)&&(i+=1,n.push("Geschlechtspräferenz erfüllt")),i+=1,n.push("Interkulturell");const u=$(e,["hobby","hobbies","hobbys"]),f=$(t,["hobby","hobbies","hobbys"]);if(u&&f){const g=un(u,f);if(g.length>0){const A=Math.min(2,g.length*.4);i+=A,g.length>=3?(n.push("Viele gemeinsame Hobbys"),s.push("Viele gemeinsame Hobbys")):g.length>=2?(n.push("Mehrere gemeinsame Hobbys"),s.push("Gemeinsame Hobbys")):n.push("Gemeinsame Hobby-Interessen")}}const b=$(e,["freizeit(?!.*vermittler)"]),E=$(t,["freizeit(?!.*vermittler)"]);if(b&&E){const g=tt(b,E);g.length>=3?(i+=1.5,n.push("Ähnliche Freizeitinteressen")):g.length>=1&&(i+=.75)}const P=$(e,["themen.*interessieren","interess.*themen"]),q=$(t,["themen.*interessieren","interess.*themen"]);if(P&&q){const g=["politik","kunst","kultur","technologie","sport","musik","natur","reisen","essen","kochen","wissenschaft","geschichte","literatur"],A=P.toLowerCase(),x=q.toLowerCase(),M=g.filter(v=>A.includes(v)&&x.includes(v));M.length>=2?(i+=1.5,n.push("Mehrere gemeinsame Interessensgebiete"),s.push("Ähnliche Interessen")):M.length===1&&(i+=.75,n.push("Gemeinsame Interessensgebiete"))}const m=$(e,["freundschaft.*wichtig","wichtig.*freundschaft"]),h=$(t,["freundschaft.*wichtig","wichtig.*freundschaft"]);if(m&&h){const g=["ehrlichkeit","vertrauen","respekt","toleranz","humor","offenheit","zuverlässigkeit","loyalität","treue"],A=m.toLowerCase(),x=h.toLowerCase(),M=g.filter(v=>A.includes(v)&&x.includes(v));M.length>=2?(i+=1.5,n.push("Ähnliche Wertvorstellungen"),s.push("Ähnliche Werte")):M.length===1&&(i+=.75)}const p=$(e,["tandem.*vorstellung(?!.*geschlecht)"]),k=$(t,["tandem.*vorstellung(?!.*geschlecht)"]);if(p&&k){const g=tt(p,k);g.length>=2?(i+=1,n.push("Ähnliche Tandem-Vorstellungen")):g.length>=1&&(i+=.5)}const S=$(e,["community-event","event.*unternehmen"]),C=$(t,["community-event","event.*unternehmen"]);if(S&&C){const g=S.toLowerCase(),A=C.toLowerCase();(g.includes("ja")||g.includes("gerne"))&&(A.includes("ja")||A.includes("gerne"))&&(i+=.5)}return i}function un(e,t){const n=e.split(/[,;]/).map(i=>Je(i.trim())).filter(Boolean),s=t.split(/[,;]/).map(i=>Je(i.trim())).filter(Boolean);return n.filter(i=>s.some(a=>i===a))}function tt(e,t){const n=new Set(["und","oder","der","die","das","ein","eine","mit","für","von","zu","ich","mir","mich","gerne","sehr","auch","aber","dass","wenn","weil","nicht","mehr","noch","schon","immer"]),s=e.toLowerCase().split(/\s+/).filter(a=>a.length>3&&!n.has(a)),i=t.toLowerCase().split(/\s+/).filter(a=>a.length>3&&!n.has(a));return s.filter(a=>i.some(r=>a===r||a.includes(r)||r.includes(a)))}let B=null,se=[];function mn(){document.getElementById("smartMatchPanel");const e=document.getElementById("closeSmartMatch");e==null||e.addEventListener("click",()=>{nt(),window.dispatchEvent(new CustomEvent("profile-deselected"))}),window.addEventListener("profile-selected",async t=>{B=t.detail.profile;const s=ne(B.id);if(s){window.dispatchEvent(new CustomEvent("edit-tandem",{detail:{tandemId:s.id,tandem:s,profileId:B.id}})),B=null;return}await hn(),fn(),wn()}),window.addEventListener("profile-deselected",()=>{B=null,se=[],nt()})}async function hn(){if(!B)return;const e=W(),t=re(),n=[];for(const s of e){if(s.id===B.id||t.has(s.id))continue;const i=Ge(B,s),a=J(B),r=J(s);let o,c;a&&r&&(o=await _t(a,r),o!==void 0&&(c=o<1?"<1 km":`${Math.round(o)} km`)),n.push({profile:s,matchResult:i,distance:o,distanceText:c})}n.sort((s,i)=>s.matchResult.compatible!==i.matchResult.compatible?s.matchResult.compatible?-1:1:s.matchResult.compatible?i.matchResult.score-s.matchResult.score:0),se=n}function fn(){const e=document.getElementById("smartMatchPanel"),t=document.getElementById("selectedProfileName"),n=document.getElementById("smartMatchContent");!e||!t||!n||!B||(t.textContent=B.name,n.innerHTML=gn(),e.classList.add("visible"),n.querySelectorAll(".match-item").forEach(s=>{s.addEventListener("click",()=>{const i=s.getAttribute("data-profile-id");i&&bn(i)})}))}function nt(){const e=document.getElementById("smartMatchPanel");e==null||e.classList.remove("visible")}function gn(){if(se.length===0)return'<p class="empty-state">Keine anderen Profile zum Matchen vorhanden.</p>';const e=se.filter(s=>s.matchResult.compatible),t=se.filter(s=>!s.matchResult.compatible);let n="";return e.length>0&&(n+='<div class="match-section"><h4>Passende Matches</h4>',n+=e.map(s=>st(s,!0)).join(""),n+="</div>"),t.length>0&&(n+='<div class="match-section"><h4>Unpassend (Hard Facts)</h4>',n+=t.map(s=>st(s,!1)).join(""),n+="</div>"),n}function st(e,t){const{profile:n,matchResult:s,distanceText:i}=e,a=pn(s.score);let r="";if(!t&&s.failReason){const c={age_preference:"🎂",gender_preference:"⚧️",time_overlap:"⏰",same_group:"👥"},l={age_preference:"Alter-Präferenz",gender_preference:"Geschlecht-Präferenz",time_overlap:"Keine Zeit-Überschneidung",same_group:"Gleiche Gruppe"},d=c[s.failReason]||"⚠️",u=l[s.failReason]||s.failReason;let f="";s.failDetails&&(f=`<div class="reason-details">${Te(s.failDetails)}</div>`),r=`
  ...
  `}function pn(e){let t="";for(let n=0;n<5;n++)t+=`<span class="star ${n<e?"":"empty"}">★</span>`;return t}function bn(e){const t=fe(e);!t||!B||window.dispatchEvent(new CustomEvent("create-match",{detail:{profile1:B,profile2:t}}))}function wn(){const e=[],t=[],n=[];for(const s of se)s.matchResult.compatible?(e.push(s.profile.id),s.matchResult.score>=4&&n.push(s.profile.id)):t.push(s.profile.id);Yt(e,t,n)}function Te(e){const t=document.createElement("div");return t.textContent=e,t.innerHTML}let ie=null;function vn(){const e=document.getElementById("importModal"),t=document.getElementById("importBtn"),n=document.getElementById("closeImportModal"),s=document.getElementById("pasteClipboard"),i=document.getElementById("dropZone"),a=document.getElementById("fileInput"),r=document.getElementById("cancelImport"),o=document.getElementById("confirmImport"),c=document.getElementById("importPreview");t==null||t.addEventListener("click",()=>it()),n==null||n.addEventListener("click",()=>Pe()),e==null||e.addEventListener("click",l=>{l.target===e&&Pe()}),s==null||s.addEventListener("click",async()=>{try{const l=await navigator.clipboard.readText();qe(l)}catch{alert("Fehler beim Lesen der Zwischenablage. Bitte erlaube den Zugriff.")}}),i==null||i.addEventListener("click",()=>a==null?void 0:a.click()),i==null||i.addEventListener("dragover",l=>{l.preventDefault(),i.classList.add("dragover")}),i==null||i.addEventListener("dragleave",()=>{i.classList.remove("dragover")}),i==null||i.addEventListener("drop",l=>{var u;l.preventDefault(),i.classList.remove("dragover");const d=(u=l.dataTransfer)==null?void 0:u.files[0];d&&rt(d)}),a==null||a.addEventListener("change",()=>{var d;const l=(d=a.files)==null?void 0:d[0];l&&rt(l)}),r==null||r.addEventListener("click",()=>{ie=null,c&&(c.hidden=!0)}),o==null||o.addEventListener("click",()=>{if(ie)try{const l=Dt(ie);alert(`${l} neue Profile importiert!`),Pe()}catch(l){alert("Fehler beim Import: "+l.message)}}),window.addEventListener("import-from-clipboard",l=>{const d=l;it(),qe(d.detail)})}function it(){const e=document.getElementById("importModal"),t=document.getElementById("importPreview");e==null||e.classList.add("visible"),t&&(t.hidden=!0),ie=null}function Pe(){const e=document.getElementById("importModal");e==null||e.classList.remove("visible"),ie=null}function rt(e){if(!e.name.endsWith(".json")){alert("Bitte eine JSON-Datei auswählen.");return}const t=new FileReader;t.onload=n=>{var i;const s=(i=n.target)==null?void 0:i.result;qe(s)},t.onerror=()=>{alert("Fehler beim Lesen der Datei.")},t.readAsText(e)}function qe(e){try{let t;if(e.includes("SWAF_PROFILE_START")?t=yn(e):t=JSON.parse(e),!t.profiles||!Array.isArray(t.profiles))throw new Error("Ungültiges Format: profiles Array nicht gefunden");ie=t,En(t)}catch(t){alert("Fehler beim Verarbeiten der Daten: "+t.message)}}function yn(e){const t=[],n=/SWAF_PROFILE_START([\s\S]*?)SWAF_PROFILE_END/g;let s;for(;(s=n.exec(e))!==null;)try{const i=JSON.parse(s[1].trim());t.push({id:crypto.randomUUID(),url:i.url||"",name:i.name||"Unbekannt",pageType:i.pageType||"Hauptprofil",timestamp:i.timestamp||Date.now(),fields:i.fields||[]})}catch{}return{version:"1.0",exportedAt:new Date().toISOString(),profiles:t}}function En(e){const t=document.getElementById("importPreview"),n=document.getElementById("previewCount"),s=document.getElementById("previewList");!t||!n||!s||(n.textContent=String(e.profiles.length),s.innerHTML=e.profiles.slice(0,10).map(i=>`<div class="preview-item">${kn(i.name)} (${i.fields.length} Felder)</div>`).join(""),e.profiles.length>10&&(s.innerHTML+=`<div class="preview-item">... und ${e.profiles.length-10} weitere</div>`),t.hidden=!1)}function kn(e){const t=document.createElement("div");return t.textContent=e,t.innerHTML}const He="https://api.swaf.koeln/ollama",Ln="ollama",Sn="Tandem2026Matcher";function je(){return{"Content-Type":"application/json",Authorization:"Basic "+btoa(`${Ln}:${Sn}`)}}async function wt(){try{console.log("🤖 Prüfe Ollama-Verfügbarkeit...");const e=await fetch(`${He}/api/tags`,{method:"GET",headers:je(),signal:AbortSignal.timeout(5e3)});return console.log(`🤖 Ollama Response: ${e.status} ${e.statusText}`),e.ok}catch(e){return console.warn("🤖 Ollama nicht erreichbar:",e),!1}}async function vt(){var e;try{const t=await fetch(`${He}/api/tags`,{headers:je()});return t.ok?((e=(await t.json()).models)==null?void 0:e.map(s=>s.name))||[]:[]}catch{return[]}}const Ae="mistral:7b";async function yt(){const e=await vt();return e.length===0?Ae:e.some(t=>t.includes("mistral"))?e.find(t=>t.includes("mistral"))||Ae:e[0]||Ae}const at={hobbys:`Du bist ein Tandem-Vermittler bei "Start with a Friend". Du schreibst eine E-Mail an zwei Personen, die du als Tandem zusammenbringen möchtest. Beschreibe ihre Hobby-Gemeinsamkeiten.
...
Gemeinsamkeit (2-3 Sätze):`,freizeit:`Du bist ein Tandem-Vermittler bei "Start with a Friend". Beschreibe die Freizeit-Gemeinsamkeiten zweier Personen, die du zusammenbringen möchtest.
...
Gemeinsamkeit (2-3 Sätze):`,interessen:`Du bist ein Tandem-Vermittler bei "Start with a Friend". Beschreibe die gemeinsamen Interessen zweier Personen.
...
Gemeinsamkeit (2-3 Sätze):`,sprachen:`Du bist ein Tandem-Vermittler bei "Start with a Friend". Beschreibe, welche Sprachen beide sprechen und wie sie kommunizieren können.
...
Sprachliche Basis (1-2 Sätze):`,beruf:`Du bist ein Tandem-Vermittler bei "Start with a Friend". Beschreibe berufliche Gemeinsamkeiten oder interessante Unterschiede.
...
Berufliche Verbindung (2-3 Sätze):`,vorher:`Du bist ein Tandem-Vermittler bei "Start with a Friend". Beschreibe die bisherigen Erfahrungen und Wege beider Personen.
...
Verbindung (2-3 Sätze):`,zukunft:`Du bist ein Tandem-Vermittler bei "Start with a Friend". Beschreibe die Zukunftspläne und wie beide voneinander profitieren könnten.
...
Zukunftsperspektive (2-3 Sätze):`,tandem_motivation:`Du bist ein Tandem-Vermittler bei "Start with a Friend". Beschreibe, warum die Motivationen beider gut zusammenpassen.
...
Motivation (2-3 Sätze):`,freundschaft_werte:`Du bist ein Tandem-Vermittler bei "Start with a Friend". Beschreibe die gemeinsamen Werte in Bezug auf Freundschaft.
...
Gemeinsame Werte (2-3 Sätze):`,events:`Du bist ein Tandem-Vermittler bei "Start with a Friend". Beschreibe, welche Events oder Aktivitäten beide gemeinsam machen könnten.
...
Aktivitäts-Vorschläge (2-3 Sätze):`,verfuegbarkeit:`Du bist ein Tandem-Vermittler bei "Start with a Friend". Analysiere die Verfügbarkeit und schlage einen passenden Zeitpunkt fürs erste Treffen vor.
...
Zeitvorschlag (1-2 Sätze):`,default:`Du bist ein Tandem-Vermittler bei "Start with a Friend". Beschreibe die Gemeinsamkeit zur Frage "{Frage}".
...
Gemeinsamkeit (1-2 Sätze):`};function In(e){const t=e.toLowerCase();return t.includes("hobby")||t.includes("hobbies")||t.includes("hobbys")?"hobbys":t.includes("freizeit")||t.includes("was machst du gerne")?"freizeit":t.includes("interesse")||t.includes("themen")?"interessen":t.includes("sprache")||t.includes("sprichst")?"sprachen":t.includes("beruf")||t.includes("arbeit")||t.includes("job")||t.includes("was machst du gerade")?"beruf":t.includes("vorher")||t.includes("früher")||t.includes("gelernt")||t.includes("was hast du")?"vorher":t.includes("zukunft")||t.includes("plan")||t.includes("ziel")||t.includes("vorhaben")?"zukunft":t.includes("warum")&&(t.includes("swaf")||t.includes("tandem")||t.includes("mitmachen"))?"tandem_motivation":t.includes("wichtig")&&(t.includes("freund")||t.includes("wert"))?"freundschaft_werte":t.includes("event")||t.includes("veranstaltung")||t.includes("unternehmen")||t.includes("aktivität")?"events":t.includes("zeit")||t.includes("wann")||t.includes("verfügbar")||t.includes("treffen")||t.includes("erreichbar")?"verfuegbarkeit":"default"}function Et(e,t,n){const s=In(e);return(at[s]||at.default).replace("{Frage}",e).replace("{Antwort1}",t).replace("{Antwort2}",n)}async function De(e,t,n,s){var r;const i=await yt();if(!i)return null;const a=Et(e,t,n);try{const o=await fetch(`${He}/api/generate`,{method:"POST",headers:je(),body:JSON.stringify({model:i,prompt:a,stream:!1,options:{temperature:.7,num_predict:400}})});if(!o.ok)return console.warn("Ollama API error:",o.status),null;const l=((r=(await o.json()).response)==null?void 0:r.trim())||null;return!l||l==="---"||l.includes("keine Gemeinsamkeit")||l.includes("keine erkennbare")?null:l.replace(/^["']|["']$/g,"").trim()}catch(o){return console.warn("Ollama generation failed:",o),null}}async function kt(){if(!await wt())return{available:!1,model:null,models:[]};const t=await vt();return{available:!0,model:await yt(),models:t}}let y=[],j="",K="",N=new Set;const $n='Schreibe hierzu einen kurzen Text. Die Frage zu den Antworten lautet {Frage}. Schreibe, wie die Antworten zusammenpassen könnten bzw. gebe Beispiele aus. Hier die Antworten: Person 1 - {Antwort1}, Person 2 - {Antwort2}. Schreibe den Text nach diesem Beispiel: "Ihr habt beide angegeben, dass ihr gerne kocht - ob mit Freund*innen oder alleine. Also los! Probiert doch einmal gemeinsam neue Rezepte. Außerdem geht ihr beide gerne Spazieren. Nach dem Essen sollst du Ruhn, oder 1.000 Schritte tun. Also habt ihr ja quasi schon einen Tagesplan ;) Weil ihr beide gerne auch kulturelle Dinge macht, wie in das Theater/Museum/oder auf andere Kulturveranstaltungen geht - schaut doch mal auf rausgegangen.de was es in Köln so die nächsten Tage gibt. Oder guckt bei uns im Eventportal: www.startwithafriend.de/events" - Nenne KEINE Namen oder andere Personenbezeichnungen.',Re=["Person","Sprachen & Herkunft","Beruf & Bildung","Hobbys & Interessen","Tandem-Wünsche","Verfügbarkeit","Sonstiges"],Mn=["vermittler","durchgeführt von","status","terminart","anmeldestatus","bearbeitungsstatus","infoabend","infonachmittag","aufnahmegespräch datum","newsletter","dsgvo","einverständnis","notizen","interne notizen","bemerkungen admin","url","link","wie wirkt die person","eindruck","einschätzung","bewertung","nächste schritte","follow-up","user-id","profil-id","teilnehmer-id","women_kpi","kpi","integrationskurs","besuchst du gerade einen integrationskurs","vorgeschlagene termine","suggested_appointments","telefonnummer","phone_number","telefon","responsible_user","responsible","registration_interview","appointment_type","appointment_info","region","department_region","department","process_history","process_current_step","flucht","einwandungserfahrung","immigration_experience","create_uid","existing_tandem_count","tandem_count","birthday","geburtstag","geburtsdatum","group","gruppe","e-mail","email","e-mail-adresse","emailadresse","nachname","last_name","lastname","familienname","full_name","fullname","vollständiger name","datum/uhrzeit","datum uhrzeit","anmeldedatum","registrierungsdatum"],Tn=["name","full name"];function Pn(e){const t=e.toLowerCase();return t.includes("name")||t.includes("alter")||t.includes("geschlecht")||t.includes("geboren")||t.includes("plz")||t.includes("postleitzahl")?"Person":t.includes("sprache")||t.includes("herkunft")||t.includes("land")||t.includes("deutschland")||t.includes("seit wann")?"Sprachen & Herkunft":t.includes("beruf")||t.includes("arbeit")||t.includes("studium")||t.includes("studiert")||t.includes("abschluss")||t.includes("branche")||t.includes("was machst du gerade")||t.includes("was hast du vorher gemacht")||t.includes("was hast du gelernt")||t.includes("in zukunft")||t.includes("zukunft gerne machen")?"Beruf & Bildung":t.includes("hobby")||t.includes("freizeit")||t.includes("interesse")||t.includes("ausprobieren")||t.includes("was machst du gerne")||t.includes("freundschaft")||t.includes("wichtig")||t.includes("event")||t.includes("anbieten")||t.includes("themen")||t.includes("community")||t.includes("unternehmen")?"Hobbys & Interessen":t.includes("tandem")||t.includes("swaf")||t.includes("mitmachen")||t.includes("warum")||t.includes("vorstellung")||t.includes("geschlecht")&&t.includes("partner")?"Tandem-Wünsche":t.includes("zeit")||t.includes("treffen")||t.includes("wann")||t.includes("erreichen")||t.includes("kontakt")||t.includes("bewegst")?"Verfügbarkeit":"Sonstiges"}function An(e){const t=e.toLowerCase().trim();return Tn.includes(t)?!0:Mn.some(n=>t.includes(n))}function Fe(e){return e?["übersprungen","keine angabe","k.a.","n/a","-","","egal","keine","null","undefined"].includes(e.toLowerCase().trim()):!0}const zn=["name","vorname","nachname","plz","postleitzahl","standort","ort","adresse","wohnort","geschlecht","gender","alter","age","geburt","in deutschland geboren","in welchem land","herkunftsland","geburtsland","woher kommst du","country","altersunterschied","geschlechterpräferenz","alterspräferenz"];function Cn(e){const t=e.toLowerCase();return zn.some(n=>t.includes(n))}function Lt(e,t,n){j=ct(t.name),K=ct(n.name);const s=new Map;function i(r,o,c){if(An(r)||!o||Fe(o))return;const l=Bn(r),d=s.get(l);d?(c?d.answer1?d.answer1!==o&&(d.answer1+="; "+o):d.answer1=o:d.answer2?d.answer2!==o&&(d.answer2+="; "+o):d.answer2=o,d.mergedQuestions.includes(r)||d.mergedQuestions.push(r)):s.set(l,{displayQuestion:r,answer1:c?o:"",answer2:c?"":o,mergedQuestions:[r]})}for(const r of t.fields)i(r.question,r.answer||"",!0);for(const r of n.fields)i(r.question,r.answer||"",!1);y=[];let a=0;for(const[r,o]of s){if(!o.answer1&&!o.answer2)continue;const c=qn(r,o.displayQuestion),l=be(c,o.answer1,o.answer2),d=l.length>0||o.answer1&&o.answer2;y.push({id:`row-${a}`,question:c,answer1:o.answer1,answer2:o.answer2,comment:l,selected:!1,included:d,collapsed:!d,category:Pn(c)}),a++}y.sort((r,o)=>{const c=Re.indexOf(r.category),l=Re.indexOf(o.category);return c!==l?c-l:r.included!==o.included?r.included?-1:1:r.question.localeCompare(o.question)}),N.clear(),pe(e);for(const r of y)(r.question.toLowerCase().includes("plz")||r.question.toLowerCase().includes("postleitzahl"))&&r.answer1&&r.answer2&&jn(r.answer1,r.answer2,r.id)}const xn=[{key:"alter",patterns:["alter","age","wie alt bist du","wie alt","dein alter","geburtsjahr"]},{key:"geschlecht",patterns:["geschlecht","gender","dein geschlecht","welches geschlecht"]},{key:"altersunterschied",patterns:["altersunterschied","alterspräferenz","age_difference","max_age_difference","maximaler altersunterschied","altersunterschied zum tandempartner"]},{key:"geschlechterpräferenz",patterns:["geschlechterpräferenz","gender_preference","geschlecht des tandems","geschlecht tandempartner","welches geschlecht soll","gewünschtes geschlecht"]},{key:"vorname",patterns:["vorname","firstname","first_name","first name"]},{key:"plz",patterns:["plz","postleitzahl","postal code","zip","zipcode","deine plz"]},{key:"hobbys",patterns:["hobbys","hobbies","hobby"]},{key:"freizeit",patterns:["freizeit","freizeitaktivitäten"]},{key:"interessen",patterns:["interessen","interests"]},{key:"sprachen",patterns:["sprachen","languages","sprache","welche sprachen sprichst du","welche sprachen"]},{key:"herkunftsland",patterns:["herkunftsland","herkunft","woher kommst du","aus welchem land","country"]},{key:"seit_wann_deutschland",patterns:["seit wann in deutschland","seit wann bist du in deutschland","wie lange in deutschland","in deutschland seit"]}],ot={vorname:"Vorname",alter:"Alter",geschlecht:"Geschlecht",plz:"PLZ",hobbys:"Hobbys",freizeit:"Freizeitaktivitäten",interessen:"Interessen",sprachen:"Sprachen",herkunftsland:"Herkunftsland",seit_wann_deutschland:"Seit wann in Deutschland",altersunterschied:"Maximaler Altersunterschied",geschlechterpräferenz:"Geschlecht des Tandempartners"};function Bn(e){const t=e.toLowerCase().replace(/[?!.,:*_-]/g," ").replace(/\s+/g," ").trim(),n=[...xn].sort((s,i)=>{const a=Math.max(...s.patterns.map(o=>o.length));return Math.max(...i.patterns.map(o=>o.length))-a});for(const s of n)for(const i of s.patterns)if(t===i||t.startsWith(i+" ")||t.endsWith(" "+i)||t.includes(" "+i+" "))return s.key;return t}function qn(e,t){return ot[e]?ot[e]:t}function pe(e){const t=N.size,n=y.filter(a=>!a.hidden),s=n.filter(a=>a.included).length,i=new Map;for(const a of n)i.has(a.category)||i.set(a.category,[]),i.get(a.category).push(a);e.innerHTML=`
  ...
  `,Rn(e)}function Dn(e){const t=N.has(e.id),n=e.comment&&e.comment.length>0;return`
  ...
  `}function Rn(e){var s,i,a;e.querySelectorAll(".include-checkbox").forEach(r=>{r.addEventListener("change",o=>{o.stopPropagation();const c=o.target,l=c.dataset.rowId;if(!l)return;const d=y.find(u=>u.id===l);if(d){d.included=c.checked,X(e);const u=e.querySelector(`.editor-row[data-row-id="${l}"]`);u&&(u.classList.toggle("included",d.included),u.classList.toggle("excluded",!d.included))}})}),e.querySelectorAll(".merge-checkbox").forEach(r=>{r.addEventListener("change",o=>{o.stopPropagation();const c=o.target,l=c.dataset.rowId;if(!l)return;c.checked?N.add(l):N.delete(l);const d=e.querySelector("#mergeRowsBtn");d&&(d.disabled=N.size<2,d.textContent=`⊕ Zusammenführen (${N.size})`)})}),e.querySelectorAll(".row-question").forEach(r=>{r.addEventListener("click",o=>{const c=r.dataset.rowId;if(!c)return;const l=y.find(d=>d.id===c);if(l){l.collapsed=!l.collapsed;const d=e.querySelector(`.editor-row[data-row-id="${c}"]`);if(d){d.classList.toggle("collapsed",l.collapsed);const u=d.querySelector(".row-details"),f=d.querySelector(".collapse-icon");u&&u.classList.toggle("hidden",l.collapsed),f&&(f.textContent=l.collapsed?"▸":"▾")}}})});function t(r){r.style.height="auto",r.style.height=Math.min(r.scrollHeight,200)+"px"}e.querySelectorAll(".answer1-input").forEach(r=>{const o=r;t(o),o.addEventListener("input",c=>{const l=c.target;t(l);const d=l.dataset.rowId;if(!d)return;const u=y.find(f=>f.id===d);u&&(u.answer1=l.value,X(e))})}),e.querySelectorAll(".answer2-input").forEach(r=>{const o=r;t(o),o.addEventListener("input",c=>{const l=c.target;t(l);const d=l.dataset.rowId;if(!d)return;const u=y.find(f=>f.id===d);u&&(u.answer2=l.value,X(e))})}),e.querySelectorAll(".comment-input").forEach(r=>{t(r)}),e.querySelectorAll(".comment-input").forEach(r=>{r.addEventListener("input",o=>{const c=o.target,l=c.dataset.rowId;if(!l)return;const d=y.find(u=>u.id===l);if(d){if(d.comment=c.value,c.value.length>0&&!d.included){d.included=!0;const u=e.querySelector(`.include-checkbox[data-row-id="${l}"]`);u&&(u.checked=!0)}X(e)}})}),e.querySelectorAll(".smart-suggest").forEach(r=>{r.addEventListener("click",async o=>{o.stopPropagation();const c=r.dataset.rowId;if(!c)return;const l=y.find(u=>u.id===c);if(!l)return;l.comment=be(l.question,l.answer1,l.answer2);const d=e.querySelector(`.comment-input[data-row-id="${c}"]`);if(d&&(d.value=l.comment),X(e),(!l.comment||l.comment.length<10)&&l.answer1&&l.answer2&&await wt()){r.textContent="...";const f=await De(l.question,l.answer1,l.answer2);f&&(l.comment=f,l.included=!0,d&&(d.value=l.comment),X(e)),r.textContent="💡"}})}),e.querySelectorAll(".ai-assist").forEach(r=>{r.addEventListener("click",o=>{o.stopPropagation();const c=r.dataset.rowId;if(!c)return;const l=y.find(d=>d.id===c);l&&Zn(l)})}),(s=e.querySelector("#mergeRowsBtn"))==null||s.addEventListener("click",()=>{Fn(),pe(e)}),(i=e.querySelector("#regenerateBtn"))==null||i.addEventListener("click",()=>{for(const r of y)r.comment=be(r.question,r.answer1,r.answer2),r.included=r.comment.length>0;pe(e)});const n=e.querySelector("#ollamaBtn");kt().then(r=>{r.available?(n.disabled=!1,n.textContent="KI generieren",n.title="Mit Mistral KI generieren"):(n.textContent="KI nicht verfügbar",n.title="KI-Server nicht erreichbar")}).catch(()=>{n.textContent="KI nicht verfügbar",n.title="Fehler bei der Verbindung zum KI-Server"}),n==null||n.addEventListener("click",async()=>{n.disabled=!0,n.textContent="KI läuft...";const r=y.filter(o=>o.answer1&&o.answer2&&!Cn(o.question)).map(o=>({question:o.question,answer1:o.answer1,answer2:o.answer2,rowId:o.id}));Jn(r,e,()=>{n.disabled=!1,n.textContent="KI generieren"})}),(a=e.querySelector("#copyEmailBtn"))==null||a.addEventListener("click",()=>{const r=Ve(),o=Qn();if(navigator.clipboard&&typeof ClipboardItem<"u"){const c=[new ClipboardItem({"text/html":new Blob([o],{type:"text/html"}),"text/plain":new Blob([r],{type:"text/plain"})})];navigator.clipboard.write(c).then(()=>{const l=e.querySelector("#copyEmailBtn");l&&(l.textContent="✓ Kopiert (Word-kompatibel)!",setTimeout(()=>l.textContent="📋 Kopieren",2e3))}).catch(()=>{navigator.clipboard.writeText(r)})}else navigator.clipboard.writeText(r).then(()=>{const c=e.querySelector("#copyEmailBtn");c&&(c.textContent="✓ Kopiert!",setTimeout(()=>c.textContent="📋 Kopieren",2e3))})})}function Fn(){if(N.size<2)return;const e=Array.from(N),t=e[0],n=y.find(i=>i.id===t);if(!n)return;const s=e.slice(1);for(const i of s){const a=y.find(r=>r.id===i);a&&(n.question+=" + "+a.question,a.answer1&&a.answer1!==n.answer1&&(n.answer1=n.answer1?n.answer1+"; "+a.answer1:a.answer1),a.answer2&&a.answer2!==n.answer2&&(n.answer2=n.answer2?n.answer2+"; "+a.answer2:a.answer2),a.comment&&(n.comment=n.comment?n.comment+"; "+a.comment:a.comment),a.hidden=!0,n.mergedWith||(n.mergedWith=[]),n.mergedWith.push(a.question.substring(0,30)))}n.comment=be(n.question,n.answer1,n.answer2),N.clear()}function be(e,t,n){const s=e.toLowerCase(),i=(t||"").toLowerCase().trim(),a=(n||"").toLowerCase().trim();if(!i&&!a||Fe(i)&&Fe(a))return"";if(i===a&&i.length>2)return s.includes("wichtig")||s.includes("freundschaft")?`Gemeinsamer Wert: ${t}`:s.includes("studium")&&i.includes("ja")?"Beide haben studiert - das verbindet!":`Übereinstimmung: ${t}`;if(s.includes("alter")&&!s.includes("unterschied")){const r=parseInt(i),o=parseInt(a);if(!isNaN(r)&&!isNaN(o)){const c=Math.abs(r-o);return c===0?"Genau gleich alt!":c<=3?`Nur ${c} Jahre Unterschied - perfekt!`:c<=7?`${c} Jahre Unterschied - passt gut`:c<=15?`${c} Jahre Unterschied - verschiedene Perspektiven`:`${c} Jahre Unterschied`}}return s.includes("sprache")||s.includes("sprichst")?Nn(t,n):s.includes("hobby")||s.includes("freizeit")||s.includes("interesse")||s.includes("ausprobieren")||s.includes("was machst du gerne")||s.includes("event")||s.includes("anbieten")||s.includes("unternehmen")||s.includes("themen")?On(t,n):s.includes("beruf")||s.includes("arbeit")||s.includes("studium")||s.includes("gelernt")||s.includes("zukunft")||s.includes("branche")||s.includes("was machst du gerade")||s.includes("vorher gemacht")?Kn(t,n):s.includes("zeit")||s.includes("treffen")||s.includes("wann")||s.includes("erreichbar")?_n(t,n):s.includes("wichtig")||s.includes("freundschaft")||s.includes("erwartung")?Gn(t,n):s.includes("plz")||s.includes("postleitzahl")?Hn(t,n):s.includes("herkunft")||s.includes("land")||s.includes("woher")?Vn(t,n):s.includes("tandem")||s.includes("warum")||s.includes("mitmachen")||s.includes("swaf")||s.includes("start with a friend")?Wn(t,n):s.includes("geschlecht")&&(s.includes("partner")||s.includes("tandem"))?Un(t,n):St(t,n)}function Nn(e,t){const n=e.toLowerCase().split(/[,;]/).map(a=>a.trim()).filter(a=>a.length>2),s=t.toLowerCase().split(/[,;]/).map(a=>a.trim()).filter(a=>a.length>2),i=n.filter(a=>s.some(r=>a.includes(r)||r.includes(a)));return i.length>0?`Gemeinsame Sprachen: ${[...new Set(i)].join(", ")}`:""}function On(e,t){const n=e.toLowerCase().split(/[,;]/).map(o=>o.trim()).filter(o=>o.length>2),s=t.toLowerCase().split(/[,;]/).map(o=>o.trim()).filter(o=>o.length>2),i=[["sport","fitness","training","gym","joggen","laufen"],["wandern","hiking","spazieren","natur","wald"],["kochen","backen","essen","kulinarisch","rezept"],["musik","konzert","instrument","singen"],["lesen","bücher","literatur"],["reisen","urlaub","travel","länder"],["film","kino","serien","netflix","movie"],["kunst","museum","malen","zeichnen","kreativ"],["tanzen","dance","salsa","bachata","tanz"],["fahrrad","radfahren","cycling","bike"],["foto","fotografieren","photography","kamera"],["café","kaffee","coffee"],["sprache","lernen","language"],["garten","pflanzen","garden"],["yoga","meditation","entspannung"],["schwimmen","baden","swimming"]],a=[];for(const o of n)for(const c of s){if(o.includes(c)||c.includes(o)){a.push(o.length>c.length?o:c);continue}for(const l of i){const d=l.some(f=>o.includes(f)),u=l.some(f=>c.includes(f));d&&u&&a.push(l[0])}}const r=[...new Set(a)];return r.length>0?r.length===1?`Gemeinsames Hobby: ${r[0]}`:`Gemeinsame Hobbys: ${r.slice(0,4).join(", ")}`:""}function _n(e,t){const n=["morgens","mittags","nachmittags","abends","wochenende","unter der woche","flexibel"],s=e.toLowerCase(),i=t.toLowerCase(),a=n.filter(r=>s.includes(r)&&i.includes(r));return a.includes("flexibel")||a.length>=2?"Zeitlich flexibel - passt gut!":a.length>0?`Gemeinsame Zeit: ${a.join(", ")}`:""}function Gn(e,t){const n=["ehrlichkeit","vertrauen","respekt","toleranz","humor","offenheit","zuverlässigkeit","kommunikation"],s=e.toLowerCase(),i=t.toLowerCase(),a=n.filter(r=>s.includes(r)&&i.includes(r));return a.length>0?`Gemeinsame Werte: ${a.join(", ")}`:""}function Hn(e,t){const n=we(e),s=we(t);return!n||!s?"":n===s?"Gleiche PLZ":n.substring(0,2)===s.substring(0,2)?"Gleiche Region - Entfernung wird berechnet...":"Entfernung wird berechnet..."}async function jn(e,t,n,s){const i=we(e),a=we(t);if(!i||!a)return;const r=y.find(c=>c.id===n);if(!r)return;const o=await Gt(i,a);if(o){const c=await Y(i),l=await Y(a);let d=Ht(o);if(c&&l){const E=jt(c,l);d+=` [🗺️](${E.google})`}r.comment=d,r.included=!0;const u=document.querySelector(`.comment-input[data-row-id="${n}"]`);u&&(u.value=ue(d));const f=document.querySelector(`.include-checkbox[data-row-id="${n}"]`);f&&(f.checked=!0);const b=document.querySelector("#emailPreview");b&&(b.innerHTML=Ke())}}function we(e){const t=e.match(/\b(\d{5})\b/);return t?t[1]:null}function Kn(e,t){const n=e.toLowerCase(),s=t.toLowerCase(),i=[["student","studier","uni","hochschule","ausbildung"],["arbeit","beruf","job","angestellt"],["selbstständig","freelance","freiberuflich"],["suche","arbeitslos","orientierung"],["it","software","computer","programmier"],["sozial","pflege","gesundheit","medizin"],["lehrer","pädagog","bildung","schule"],["ingenieur","technik","maschinenbau"],["wirtschaft","bwl","marketing","vertrieb"],["kunst","design","kreativ","musik"]],a=[];for(const r of i){const o=r.some(l=>n.includes(l)),c=r.some(l=>s.includes(l));o&&c&&a.push(r[0])}return a.length>0?`Ähnlicher Bereich: ${a.join(", ")}`:(n.includes("student")||n.includes("studier"))&&(s.includes("student")||s.includes("studier"))?"Beide studieren - viel gemeinsam!":St(e,t)}function Vn(e,t){const n=e.toLowerCase(),s=t.toLowerCase(),i=["deutschland","syrien","iran","irak","afghanistan","türkei","ukraine","eritrea","somalia","nigeria","pakistan","indien","china","russland"];for(const a of i)if(n.includes(a)&&s.includes(a))return`Beide haben Bezug zu ${a.charAt(0).toUpperCase()+a.slice(1)}`;return(n.includes("kultur")||n.includes("tradition"))&&(s.includes("kultur")||s.includes("tradition"))?"Beide interessiert an Kultur & Traditionen":""}function Wn(e,t){const n=e.toLowerCase(),s=t.toLowerCase(),i=[{keywords:["sprache","deutsch","lernen","verbessern"],text:"Beide wollen Sprachkenntnisse verbessern"},{keywords:["freund","kennenlernen","kontakt","leute"],text:"Beide suchen neue Kontakte"},{keywords:["kultur","austausch","integration"],text:"Beide wollen kulturellen Austausch"},{keywords:["helfen","unterstütz","begleiten"],text:"Gegenseitige Unterstützung ist wichtig"},{keywords:["spaß","unternehmung","aktivität"],text:"Beide wollen gemeinsam Spaß haben"}];for(const a of i){const r=a.keywords.some(c=>n.includes(c)),o=a.keywords.some(c=>s.includes(c));if(r&&o)return a.text}return""}function Un(e,t){const n=e.toLowerCase(),s=t.toLowerCase();return(n.includes("egal")||n.includes("keine präferenz"))&&(s.includes("egal")||s.includes("keine präferenz"))?"Beide flexibel beim Geschlecht":""}function St(e,t){if(!e||!t)return"";const n=new Set(["und","oder","der","die","das","ein","eine","mit","für","von","zu","ich","mir","gerne","sehr","auch","aber","wenn","dann","noch","schon","kann","will","muss","soll","hat","haben","sein","wird","sind","ist","nicht","mehr","viel","viele","alle","diese","dies","dem","den","des"]),s=e.toLowerCase().replace(/[.,!?;:()]/g," ").split(/\s+/).filter(o=>o.length>3&&!n.has(o)),i=t.toLowerCase().replace(/[.,!?;:()]/g," ").split(/\s+/).filter(o=>o.length>3&&!n.has(o)),a=s.filter(o=>i.some(c=>o===c||o.length>4&&c.length>4&&(o.includes(c)||c.includes(o)))),r=[...new Set(a)];return r.length>=1?`Gemeinsam: ${r.slice(0,4).join(", ")}`:e.length>5&&t.length>5?"Beide haben geantwortet":""}function X(e){const t=e.querySelector("#emailPreview");t&&(t.innerHTML=Ke())}function Ke(){const t=y.filter(s=>s.included).filter(s=>s.answer1||s.answer2);let n=`
    <div class="email-intro">
      Hi <strong>${w(j)}</strong> und <strong>${w(K)}</strong>,<br><br>
  ...
  `,n}function Zn(e,t){var a,r,o,c;const s=(localStorage.getItem("swaf_ai_prompt")||$n).replace("{Frage}",e.question).replace("{Antwort1}",e.answer1||"keine Angabe").replace("{Antwort2}",e.answer2||"keine Angabe"),i=document.createElement("div");i.className="ai-modal-overlay",i.innerHTML=`
    <div class="ai-modal">
      ...
      <div class="ai-preview-item ${m.status}" data-index="${h}" id="preview-item-${h}">
        ...
        <div class="ai-preview-content">
          ...
          <details class="ai-item-prompt">
            ...
            <pre class="ai-prompt-mini">${w(Et(m.question,m.answer1,m.answer2))}</pre>
          </details>
        </div>
      </div>
    `}function l(m,h){return m.status==="pending"?'<div class="ai-preview-pending">Wartet...</div>':m.status==="generating"?'<div class="ai-preview-generating"><span class="ai-mini-spinner"></span> Generiere...</div>':m.status==="error"?'<div class="ai-preview-error">Fehler - klicke 🔄 zum erneuten Versuch</div>':`<textarea class="ai-preview-textarea" data-index="${h}" rows="4">${w(m.generated)}</textarea>`}function d(m){const h=s[m],p=r.querySelector(`#preview-item-${m}`);if(!p)return;p.className=`ai-preview-item ${h.status}`;const k=p.querySelector(`#result-${m}`);if(k){k.innerHTML=l(h,m);const g=k.querySelector(".ai-preview-textarea");g&&g.addEventListener("input",A=>{const x=A.target;s[m].generated=x.value})}const S=p.querySelector('input[type="checkbox"]');S&&(S.disabled=h.status!=="done",S.checked=h.selected);const C=p.querySelector(".ai-regenerate-btn");C&&(C.disabled=h.status==="generating"),u()}function u(){const m=s.filter(C=>C.status==="done").length,h=s.filter(C=>C.selected&&C.status==="done").length,p=r.querySelector("#progressText");p&&(p.textContent=`${m}/${e.length} generiert`);const k=r.querySelector("#selectedCount");k&&(k.textContent=String(h));const S=r.querySelector("#applyPreviewBtn");S&&(S.disabled=h===0)}function f(){const m=r.querySelector("#progressInfo");if(m){const k=s.filter(S=>S.status==="done").length;m.innerHTML=`<span id="progressText">${k} Vorschläge generiert</span>`}const h=r.querySelector("#introText");if(h){const k=s.filter(S=>S.status==="done").length;h.innerHTML=`<strong>${k} Vorschläge generiert.</strong> Wähle aus, welche du übernehmen möchtest:`}const p=r.querySelector("#stopGenerationBtn");p&&(p.style.display="none")}function b(){var m,h,p,k,S,C,g,A,x;(m=r.querySelector(".close-modal"))==null||m.addEventListener("click",()=>{i=!0,r.remove(),n()}),r.addEventListener("click",M=>{M.target===r&&(i=!0,r.remove(),n())}),(h=r.querySelector("#cancelPreviewBtn"))==null||h.addEventListener("click",()=>{i=!0,r.remove(),n()}),(p=r.querySelector("#stopGenerationBtn"))==null||p.addEventListener("click",()=>{i=!0,f()}),(k=r.querySelector("#selectAllBtn"))==null||k.addEventListener("click",()=>{s.forEach((M,v)=>{if(M.status==="done"){M.selected=!0;const D=r.querySelector(`#preview-item-${v} input[type="checkbox"]`);D&&(D.checked=!0)}}),u()}),(S=r.querySelector("#selectNoneBtn"))==null||S.addEventListener("click",()=>{s.forEach((M,v)=>{M.selected=!1;const D=r.querySelector(`#preview-item-${v} input[type="checkbox"]`);D&&(D.checked=!1)}),u()}),(C=r.querySelector("#previewList"))==null||C.addEventListener("change",M=>{const v=M.target;if(v.type==="checkbox"&&v.dataset.index){const D=parseInt(v.dataset.index,10);s[D].selected=v.checked,u()}}),(g=r.querySelector("#previewList"))==null||g.addEventListener("input",M=>{const v=M.target;if(v.classList.contains("ai-preview-textarea")&&v.dataset.index){const D=parseInt(v.dataset.index,10);s[D].generated=v.value}}),(A=r.querySelector("#previewList"))==null||A.addEventListener("click",async M=>{const v=M.target;if(v.classList.contains("ai-regenerate-btn")&&v.dataset.index){const D=parseInt(v.dataset.index,10);await E(D)}}),(x=r.querySelector("#applyPreviewBtn"))==null||x.addEventListener("click",()=>{i=!0,P(),r.remove(),n()})}async function E(m){if(a.has(m))return;const h=s[m];a.add(m),h.status="generating",d(m);try{const p=await De(h.question,h.answer1,h.answer2);p?(h.generated=p,h.status="done",h.selected=!0):h.status="error"}catch(p){console.warn("Regeneration error:",p),h.status="error"}a.delete(m),d(m)}function P(){let m=0;for(const h of s)if(h.selected&&h.status==="done"&&h.generated){const p=y.find(k=>k.id===h.rowId);p&&(p.comment=h.generated,p.included=!0,m++)}pe(t),m>0&&Ne(`${m} KI-Vorschläge übernommen`)}r.innerHTML=o(),document.body.appendChild(r),b();async function q(){for(let m=0;m<s.length&&!i;m++){const h=s[m];h.status="generating",d(m);try{const p=await De(h.question,h.answer1,h.answer2);if(i)break;p?(h.generated=p,h.status="done"):(h.status="error",h.selected=!1)}catch(p){console.warn("Generation error:",p),h.status="error",h.selected=!1}d(m)}f()}q()}function Ve(){const t=y.filter(i=>i.included).filter(i=>i.answer1||i.answer2);let n=`Hi ${j} und ${K},
...
`;const s={question:Math.max(10,...t.map(i=>i.question.length)),answer1:Math.max(j.length,...t.map(i=>(i.answer1||"-").length)),answer2:Math.max(K.length,...t.map(i=>(i.answer2||"-").length))};s.question=Math.min(s.question,30),s.answer1=Math.min(s.answer1,25),s.answer2=Math.min(s.answer2,25),n+=ee("Frage",s.question)+" | ",n+=ee(j,s.answer1)+" | ",n+=ee(K,s.answer2)+" | ",n+=`Gemeinsamkeit
...
`,n}function ee(e,t){return e.length>=t?e.substring(0,t):e+" ".repeat(t-e.length)}function ce(e,t){return e?e.length<=t?e:e.substring(0,t-2)+"..":""}function Qn(){const t=y.filter(s=>s.included).filter(s=>s.answer1||s.answer2);let n=`<!--StartFragment-->
...
`;for(const o of n.commonalities)a+=te(ze(o.question,r.question),r.question)+" | ",a+=te(ze(o.answer1||"-",r.answer1),r.answer1)+" | ",a+=te(ze(o.answer2||"-",r.answer2),r.answer2)+" | ",a+=(o.commonality||"")+`
`}a+=`
Ich freue mich über eure Rückmeldung!
`,navigator.clipboard.writeText(a).then(()=>{ut("Text kopiert!")}).catch(()=>{alert("Fehler beim Kopieren")})}function te(e,t){return e.length>=t?e.substring(0,t):e+" ".repeat(t-e.length)}function ze(e,t){return e?e.length<=t?e:e.substring(0,t-2)+"..":""}function dt(e){if(!e||typeof e!="string")return"Partner*in";const t=e.match(/\(([^)]+)\)/);if(t){const s=t[1].trim().split(/[\s,]+/)[0];if(s&&s.length>1&&!/^(locals?|einwander|interview|gespräch)/i.test(s))return s}if(!/^(aufnahmegespräch|interview|gespräch)/i.test(e)){const n=e.split(/[\s,]+/)[0];if(n&&n.length>1)return n}return"Partner*in"}function ut(e){let t=document.getElementById("successToast");t||(t=document.createElement("div"),t.id="successToast",t.className="success-toast",document.body.appendChild(t)),t.textContent=e,t.classList.add("visible"),setTimeout(()=>t==null?void 0:t.classList.remove("visible"),2e3)}function ss(e){const t=new Date(e.created).toLocaleDateString("de-DE"),n=Ue(e.matchScore);return`
  ...
  `;const a=document.getElementById("tandemEditorContainer");a&&Lt(a,e,t),n.classList.add("visible")}function Oe(){const e=document.getElementById("matchModal");e==null||e.classList.remove("visible"),ve=null}function rs(){if(!ve)return;const{profile1:e,profile2:t}=ve,n=Ge(e,t),s=Ve(),i=It(),a={id:crypto.randomUUID(),profile1:e,profile2:t,name:`${e.name} & ${t.name}`,created:new Date().toISOString(),commonalities:i,matchScore:n.score,suggestionText:s};Ct(a),Oe(),Ze(`Tandem erstellt: ${e.name} & ${t.name}`)}function Ze(e){let t=document.getElementById("successToast");t||(t=document.createElement("div"),t.id="successToast",t.className="success-toast",document.body.appendChild(t)),t.textContent=e,t.classList.add("visible"),setTimeout(()=>t==null?void 0:t.classList.remove("visible"),3e3)}function _(e){const t=document.createElement("div");return t.textContent=e,t.innerHTML}let V=null;function as(e){var s,i,a,r;V=e;let t=document.getElementById("editTandemModal");t||(t=document.createElement("div"),t.id="editTandemModal",t.className="modal",t.innerHTML=`
...
`);$t(s,`tandems_${new Date().toISOString().split("T")[0]}.csv`,"text/csv;charset=utf-8")}function gs(){const e=Rt();$t(e,`tandem-matcher-backup_${new Date().toISOString().split("T")[0]}.json`,"application/json")}function ps(){const e=document.createElement("input");e.type="file",e.accept=".json",e.onchange=t=>{var i;const n=(i=t.target.files)==null?void 0:i[0];if(!n)return;const s=new FileReader;s.onload=a=>{var r;try{const o=(r=a.target)==null?void 0:r.result;confirm("Achtung: Alle bestehenden Daten werden überschrieben. Fortfahren?")&&(Ft(o),alert("Backup erfolgreich wiederhergestellt!"),location.reload())}catch(o){alert("Fehler beim Wiederherstellen: "+o.message)}},s.readAsText(n)},e.click()}function $t(e,t,n){const s=new Blob([e],{type:n}),i=URL.createObjectURL(s),a=document.createElement("a");a.href=i,a.download=t,document.body.appendChild(a),a.click(),document.body.removeChild(a),URL.revokeObjectURL(i)}function bs(){const e=W();if(e.length===0){alert("Keine Profile vorhanden.");return}confirm(`Möchtest du wirklich ALLE ${e.length} Profile löschen?

Diese Aktion kann nicht rückgängig gemacht werden!`)&&confirm("Bist du sicher? Alle Profile werden unwiderruflich gelöscht.")&&(zt(),window.dispatchEvent(new Event("profiles-updated")),alert("Alle Profile wurden gelöscht."))}function ws(){const e=W();if(re(),e.length===0){alert("Keine Profile vorhanden.");return}const t=document.createElement("div");t.className="modal visible",t.id="profileManageModal";function n(){const c=W(),l=re();return c.map(d=>{const u=l.has(d.id),f=d.group==="local"?"Local":"Newcomer",b=d.group==="local"?"local":"newcomer";return`
  ...
  `,document.body.appendChild(t);const s=t.querySelector("#closeProfileManageModal"),i=t.querySelector("#closeProfileManageBtn"),a=t.querySelector("#profileSearchInput"),r=t.querySelector("#profileManageList");function o(){t.remove()}s==null||s.addEventListener("click",o),i==null||i.addEventListener("click",o),t.addEventListener("click",c=>{c.target===t&&o()}),a==null||a.addEventListener("input",()=>{const c=a.value.toLowerCase(),l=r==null?void 0:r.querySelectorAll(".profile-manage-item");l==null||l.forEach(d=>{var f,b;const u=((b=(f=d.querySelector(".profile-manage-name"))==null?void 0:f.textContent)==null?void 0:b.toLowerCase())||"";d.style.display=u.includes(c)?"flex":"none"})}),r==null||r.addEventListener("click",c=>{var d,u;const l=c.target;if(l.classList.contains("profile-delete-btn")&&!l.hasAttribute("disabled")){const f=l.dataset.id;if(!f)return;const b=((u=(d=l.closest(".profile-manage-item"))==null?void 0:d.querySelector(".profile-manage-name"))==null?void 0:u.textContent)||"Unbekannt";if(confirm(`Profil "${b}" wirklich löschen?`)){At(f),window.dispatchEvent(new Event("profiles-updated")),r&&(r.innerHTML=n());const P=t.querySelector(".profile-manage-header p"),q=W();P&&(P.innerHTML=`<strong>${q.length}</strong> Profile geladen`),q.length===0&&(o(),alert("Alle Profile wurden gelöscht."))}}})}function vs(e){if(!e)return"";const t=document.createElement("div");return t.textContent=e,t.innerHTML}document.addEventListener("DOMContentLoaded",async()=>{console.log("Tandem-Matcher v2.0 initialisiert"),await Mt(),ys(),vn(),Kt(),en(),mn(),ts(),ms(),Es(),Ss(),Ls(),ks()});function ys(){const e=document.querySelectorAll(".tab"),t=document.querySelectorAll(".tab-content");e.forEach(n=>{n.addEventListener("click",()=>{const s=n.dataset.tab;s&&(e.forEach(i=>i.classList.remove("active")),n.classList.add("active"),t.forEach(i=>{i.classList.toggle("active",i.id===`${s}-tab`)}))})})}function Es(){const e=document.querySelectorAll(".view-btn"),t=document.getElementById("profileSidebar"),n=document.getElementById("mapContainer");e.forEach(s=>{s.addEventListener("click",()=>{const i=s.dataset.view;!i||!t||!n||(e.forEach(a=>a.classList.remove("active")),s.classList.add("active"),i==="list"?(t.classList.add("mobile-visible"),n.classList.add("mobile-hidden")):(t.classList.remove("mobile-visible"),n.classList.remove("mobile-hidden"),setTimeout(()=>{window.dispatchEvent(new Event("resize")),window.dispatchEvent(new Event("map-needs-resize"))},100)))})})}async function ks(){const e=document.getElementById("ollamaStatus");if(e)try{const t=await kt();t.available&&t.model?(e.className="ollama-status available",e.textContent=`Verfügbar: ${t.model}`):t.available?(e.className="ollama-status unavailable",e.textContent="Ollama läuft, aber kein Modell installiert"):(e.className="ollama-status unavailable",e.textContent="Nicht verfügbar - Ollama installieren")}catch{e.className="ollama-status unavailable",e.textContent="Nicht verfügbar"}}function Ls(){const e=document.getElementById("helpBtn"),t=document.getElementById("helpModal"),n=document.getElementById("closeHelpModal");e==null||e.addEventListener("click",()=>{t==null||t.classList.add("visible")}),n==null||n.addEventListener("click",()=>{t==null||t.classList.remove("visible")}),t==null||t.addEventListener("click",s=>{s.target===t&&t.classList.remove("visible")}),localStorage.getItem("swaf_help_shown")||setTimeout(()=>{t==null||t.classList.add("visible"),localStorage.setItem("swaf_help_shown","true")},500)}function Ss(){window.addEventListener("focus",async()=>{try{const e=await navigator.clipboard.readText();e&&e.includes('"version"')&&e.includes('"profiles"')&&confirm("Profile-Daten in der Zwischenablage erkannt. Importieren?")&&window.dispatchEvent(new CustomEvent("import-from-clipboard",{detail:e}))}catch{}})}window.TandemMatcher={version:"2.0.0"};
