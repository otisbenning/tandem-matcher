...
Kommentar (1-2 Sätze):`,freizeit:`Schreibe einen Kommentar zu Freizeit-Gemeinsamkeiten.
...
Kommentar (1-2 Sätze):`,interessen:`Schreibe einen Kommentar zu gemeinsamen Interessen.
...
Kommentar (1-2 Sätze):`,sprachen:`Schreibe einen Kommentar zu Sprachkenntnissen.
...
Kommentar (1-2 Sätze):`,beruf:`Schreibe einen Kommentar zu beruflichen Verbindungen.
...
Kommentar (1-2 Sätze):`,vorher:`Schreibe einen Kommentar zu bisherigen Erfahrungen.
...
Kommentar (1-2 Sätze):`,zukunft:`Schreibe einen Kommentar zu Zukunftsplänen.
...
Kommentar (1-2 Sätze):`,tandem_motivation:`Schreibe einen Kommentar zur Tandem-Motivation.
...
Kommentar (1-2 Sätze):`,freundschaft_werte:`Schreibe einen Kommentar zu Freundschafts-Werten.
...
Kommentar (1-2 Sätze):`,events:`Schreibe einen Kommentar zu gemeinsamen Aktivitäten/Events.
...
Kommentar (1-2 Sätze):`,verfuegbarkeit:`Schreibe einen Kommentar zur zeitlichen Verfügbarkeit.
...
Kommentar (1 Satz):`,default:`Schreibe einen Kommentar zur Frage "{Frage}".
...
Kommentar (1-2 Sätze oder "---"):`};function In(e){const t=e.toLowerCase();return t.includes("hobby")||t.includes("hobbies")||t.includes("hobbys")?"hobbys":t.includes("freizeit")||t.includes("was machst du gerne")?"freizeit":t.includes("interesse")||t.includes("themen")?"interessen":t.includes("sprache")||t.includes("sprichst")?"sprachen":t.includes("beruf")||t.includes("arbeit")||t.includes("job")||t.includes("was machst du gerade")?"beruf":t.includes("vorher")||t.includes("früher")||t.includes("gelernt")||t.includes("was hast du")?"vorher":t.includes("zukunft")||t.includes("plan")||t.includes("ziel")||t.includes("vorhaben")?"zukunft":t.includes("warum")&&(t.includes("swaf")||t.includes("tandem")||t.includes("mitmachen"))?"tandem_motivation":t.includes("wichtig")&&(t.includes("freund")||t.includes("wert"))?"freundschaft_werte":t.includes("event")||t.includes("veranstaltung")||t.includes("unternehmen")||t.includes("aktivität")?"events":t.includes("zeit")||t.includes("wann")||t.includes("verfügbar")||t.includes("treffen")||t.includes("erreichbar")?"verfuegbarkeit":"default"}function $t(e,t,n){const i=In(e);return(dt[i]||dt.default).replace("{Frage}",e).replace("{Antwort1}",t).replace("{Antwort2}",n)}async function _e(e,t,n,i){var r;const s=await St();if(!s)return null;const a=$t(e,t,n);try{const o=await fetch(`${Ze}/api/generate`,{method:"POST",headers:We(),body:JSON.stringify({model:s,prompt:a,stream:!1,options:{temperature:.7,num_predict:200}})});if(!o.ok)return console.warn("Ollama API error:",o.status),null;const l=((r=(await o.json()).response)==null?void 0:r.trim())||null;return!l||l==="---"||l.includes("keine Gemeinsamkeit")||l.includes("keine erkennbare")?null:l.replace(/^["']|["']$/g,"").trim()}catch(o){return console.warn("Ollama generation failed:",o),null}}async function Mt(){if(!await kt())return{available:!1,model:null,models:[]};const t=await Lt();return{available:!0,model:await St(),models:t}}let y=[],K="",H="",D=new Set;const zn='Schreibe hierzu einen kurzen Text. Die Frage zu den Antworten lautet {Frage}. Schreibe, wie die Antworten zusammenpassen könnten bzw. gebe Beispiele aus. Hier die Antworten: Person 1 - {Antwort1}, Person 2 - {Antwort2}. Schreibe den Text nach diesem Beispiel: "Ihr habt beide angegeben, dass ihr gerne kocht - ob mit Freund*innen oder alleine. Also los! Probiert doch einmal gemeinsam neue Rezepte. Außerdem geht ihr beide gerne Spazieren. Nach dem Essen sollst du Ruhn, oder 1.000 Schritte tun. Also habt ihr ja quasi schon einen Tagesplan ;) Weil ihr beide gerne auch kulturelle Dinge macht, wie in das Theater/Museum/oder auf andere Kulturveranstaltungen geht - schaut doch mal auf rausgegangen.de was es in Köln so die nächsten Tage gibt. Oder guckt bei uns im Eventportal: www.startwithafriend.de/events" - Nenne KEINE Namen oder andere Personenbezeichnungen.',Re=["Person","Sprachen & Herkunft","Beruf & Bildung","Hobbys & Interessen","Tandem-Wünsche","Verfügbarkeit","Sonstiges"],Cn=["vermittler","durchgeführt von","status","terminart","anmeldestatus","bearbeitungsstatus","infoabend","infonachmittag","aufnahmegespräch datum","newsletter","dsgvo","einverständnis","notizen","interne notizen","bemerkungen admin","url","link","wie wirkt die person","eindruck","einschätzung","bewertung","nächste schritte","follow-up","user-id","profil-id","teilnehmer-id","women_kpi","kpi","integrationskurs","besuchst du gerade einen integrationskurs","vorgeschlagene termine","suggested_appointments","telefonnummer","phone_number","telefon","responsible_user","responsible","registration_interview","appointment_type","appointment_info","region","department_region","department","process_history","process_current_step","flucht","einwandungserfahrung","immigration_experience","create_uid","existing_tandem_count","tandem_count","birthday","geburtstag","geburtsdatum","group","gruppe","e-mail","email","e-mail-adresse","emailadresse","nachname","last_name","lastname","familienname","full_name","fullname","vollständiger name","datum/uhrzeit","datum uhrzeit","anmeldedatum","registrierungsdatum"],xn=["name","full name"];function Pn(e){const t=e.toLowerCase();return t.includes("name")||t.includes("alter")||t.includes("geschlecht")||t.includes("geboren")||t.includes("plz")||t.includes("postleitzahl")?"Person":t.includes("sprache")||t.includes("herkunft")||t.includes("land")||t.includes("deutschland")||t.includes("seit wann")?"Sprachen & Herkunft":t.includes("beruf")||t.includes("arbeit")||t.includes("studium")||t.includes("studiert")||t.includes("abschluss")||t.includes("branche")||t.includes("was machst du gerade")||t.includes("was hast du vorher gemacht")||t.includes("was hast du gelernt")||t.includes("in zukunft")||t.includes("zukunft gerne machen")?"Beruf & Bildung":t.includes("hobby")||t.includes("freizeit")||t.includes("interesse")||t.includes("ausprobieren")||t.includes("was machst du gerne")||t.includes("freundschaft")||t.includes("wichtig")||t.includes("event")||t.includes("anbieten")||t.includes("themen")||t.includes("community")||t.includes("unternehmen")?"Hobbys & Interessen":t.includes("tandem")||t.includes("swaf")||t.includes("mitmachen")||t.includes("warum")||t.includes("vorstellung")||t.includes("geschlecht")&&t.includes("partner")?"Tandem-Wünsche":t.includes("zeit")||t.includes("treffen")||t.includes("wann")||t.includes("erreichen")||t.includes("kontakt")||t.includes("bewegst")?"Verfügbarkeit":"Sonstiges"}function Bn(e){const t=e.toLowerCase().trim();return xn.includes(t)?!0:Cn.some(n=>t.includes(n))}function Fe(e){return e?["übersprungen","keine angabe","k.a.","n/a","-","","egal","keine","null","undefined"].includes(e.toLowerCase().trim()):!0}const qn=["name","vorname","nachname","plz","postleitzahl","standort","ort","adresse","wohnort","geschlecht","gender","alter","age","geburt","in deutschland geboren","in welchem land","herkunftsland","geburtsland","woher kommst du","country","altersunterschied","geschlechterpräferenz","alterspräferenz"];function On(e){const t=e.toLowerCase();return qn.some(n=>t.includes(n))}function Tt(e,t,n){localStorage.removeItem("swaf_ai_suggestions_cache"),K=mt(t.name),H=mt(n.name);const i=new Map;function s(r,o,c){if(Bn(r)||!o||Fe(o))return;const l=Dn(r),d=i.get(l);d?(c?d.answer1?d.answer1!==o&&(d.answer1+="; "+o):d.answer1=o:d.answer2?d.answer2!==o&&(d.answer2+="; "+o):d.answer2=o,d.mergedQuestions.includes(r)||d.mergedQuestions.push(r)):i.set(l,{displayQuestion:r,answer1:c?o:"",answer2:c?"":o,mergedQuestions:[r]})}for(const r of t.fields)s(r.question,r.answer||"",!0);for(const r of n.fields)s(r.question,r.answer||"",!1);y=[];let a=0;for(const[r,o]of i){if(!o.answer1&&!o.answer2)continue;const c=_n(r,o.displayQuestion),l=Ee(c,o.answer1,o.answer2),d=l.length>0||o.answer1&&o.answer2;y.push({id:`row-${a}`,question:c,answer1:o.answer1,answer2:o.answer2,comment:l,selected:!1,included:d,collapsed:!d,category:Pn(c)}),a++}y.sort((r,o)=>{const c=Re.indexOf(r.category),l=Re.indexOf(o.category);return c!==l?c-l:r.included!==o.included?r.included?-1:1:r.question.localeCompare(o.question)}),D.clear(),ye(e);for(const r of y)(r.question.toLowerCase().includes("plz")||r.question.toLowerCase().includes("postleitzahl"))&&r.answer1&&r.answer2&&Wn(r.answer1,r.answer2,r.id)}const Nn=[{key:"alter",patterns:["alter","age","wie alt bist du","wie alt","dein alter","geburtsjahr"]},{key:"geschlecht",patterns:["geschlecht","gender","dein geschlecht","welches geschlecht"]},{key:"altersunterschied",patterns:["altersunterschied","alterspräferenz","age_difference","max_age_difference","maximaler altersunterschied","altersunterschied zum tandempartner"]},{key:"geschlechterpräferenz",patterns:["geschlechterpräferenz","gender_preference","geschlecht des tandems","geschlecht tandempartner","welches geschlecht soll","gewünschtes geschlecht"]},{key:"vorname",patterns:["vorname","firstname","first_name","first name"]},{key:"plz",patterns:["plz","postleitzahl","postal code","zip","zipcode","deine plz"]},{key:"hobbys",patterns:["hobbys","hobbies","hobby"]},{key:"freizeit",patterns:["freizeit","freizeitaktivitäten"]},{key:"interessen",patterns:["interessen","interests"]},{key:"sprachen",patterns:["sprachen","languages","sprache","welche sprachen sprichst du","welche sprachen"]},{key:"herkunftsland",patterns:["herkunftsland","herkunft","woher kommst du","aus welchem land","country"]},{key:"seit_wann_deutschland",patterns:["seit wann in deutschland","seit wann bist du in deutschland","wie lange in deutschland","in deutschland seit"]}],ut={vorname:"Vorname",alter:"Alter",geschlecht:"Geschlecht",plz:"PLZ",hobbys:"Hobbys",freizeit:"Freizeitaktivitäten",interessen:"Interessen",sprachen:"Sprachen",herkunftsland:"Herkunftsland",seit_wann_deutschland:"Seit wann in Deutschland",altersunterschied:"Maximaler Altersunterschied",geschlechterpräferenz:"Geschlecht des Tandempartners"};function Dn(e){const t=e.toLowerCase().replace(/[?!.,:*_-]/g," ").replace(/\s+/g," ").trim(),n=[...Nn].sort((i,s)=>{const a=Math.max(...i.patterns.map(o=>o.length));return Math.max(...s.patterns.map(o=>o.length))-a});for(const i of n)for(const s of i.patterns)if(t===s||t.startsWith(s+" ")||t.endsWith(" "+s)||t.includes(" "+s+" "))return i.key;return t}function _n(e,t){return ut[e]?ut[e]:t}function ye(e){const t=D.size,n=y.filter(a=>!a.hidden),i=n.filter(a=>a.included).length,s=new Map;for(const a of n)s.has(a.category)||s.set(a.category,[]),s.get(a.category).push(a);e.innerHTML=`
  ...
  `,Fn(e)}function Rn(e){const t=D.has(e.id),n=e.comment&&e.comment.length>0;return`
...
`);zt(i,`tandems_${new Date().toISOString().split("T")[0]}.csv`,"text/csv;charset=utf-8")}function vi(){const e=Ft();zt(e,`tandem-matcher-backup_${new Date().toISOString().split("T")[0]}.json`,"application/json")}function yi(){const e=document.createElement("input");e.type="file",e.accept=".json",e.onchange=t=>{var s;const n=(s=t.target.files)==null?void 0:s[0];if(!n)return;const i=new FileReader;i.onload=a=>{var r;try{const o=(r=a.target)==null?void 0:r.result;confirm("Achtung: Alle bestehenden Daten werden überschrieben. Fortfahren?")&&(Gt(o),alert("Backup erfolgreich wiederhergestellt!"),location.reload())}catch(o){alert("Fehler beim Wiederherstellen: "+o.message)}},i.readAsText(n)},e.click()}function zt(e,t,n){const i=new Blob([e],{type:n}),s=URL.createObjectURL(i),a=document.createElement("a");a.href=s,a.download=t,document.body.appendChild(a),a.click(),document.body.removeChild(a),URL.revokeObjectURL(s)}function Ei(){const e=U();if(e.length===0){alert("Keine Profile vorhanden.");return}confirm(`Möchtest du wirklich ALLE ${e.length} Profile löschen?
